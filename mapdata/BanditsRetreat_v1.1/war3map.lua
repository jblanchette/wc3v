...
function InitAllyPriorities()
    ...
    SetEnemyStartLocPrio(0, 3, 4, MAP_LOC_PRIO_LOW)
    SetEnemyStartLocPrio(0, 4, 5, MAP_LOC_PRIO_LOW)
    SetEnemyStartLocPrio(0, 5, 6, MAP_LOC_PRIO_LOW)
    ...
    SetEnemyStartLocPrio(4, 3, 5, MAP_LOC_PRIO_LOW)
    ...
    SetEnemyStartLocPrio(6, 5, 7, MAP_LOC_PRIO_LOW)
    ...
    SetEnemyStartLocPrio(7, 1, 2, MAP_LOC_PRIO_LOW)
...
function config()
    ...
    DefineStartLocation(1, 3264.0, -7424.0)
    DefineStartLocation(2, 7424.0, -3264.0)
    DefineStartLocation(3, 7424.0, 3264.0)
    DefineStartLocation(4, 3264.0, 7424.0)
    DefineStartLocation(5, -3264.0, 7424.0)
    DefineStartLocation(6, -7424.0, 3264.0)
    DefineStartLocation(7, -7424.0, -3264.0)
