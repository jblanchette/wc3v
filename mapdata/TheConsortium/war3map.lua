...
gg_rct_Fog3 = nil
gg_rct_Fog4 = nil
gg_rct_Fog2_Copy = nil
gg_rct_Fog3_Copy = nil
gg_rct_Fog4_Copy = nil
...
function CreateNeutralHostile()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), -1558.6, -2739.9, 31.049, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), -2961.5, 1616.0, 282.142, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrh"), -4027.3, -5907.7, 75.526, FourCC("ndrh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000081_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), -2524.7, -697.4, 31.984, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), -843.1, 2539.8, 287.393, FourCC("nsrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrh"), -1659.0, -6226.6, 16.400, FourCC("ndrh"))
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), 2466.6, 668.3, 211.984, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfov"), 3329.5, -5604.3, 70.910, FourCC("nfov"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000024_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nhdc"), 2745.0, 526.8, 217.883, FourCC("nhdc"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrn"), 2603.6, 629.6, 216.171, FourCC("nsrn"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000089_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), -3178.7, 1300.8, 1.077, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("npfl"), -5451.1, -3168.4, 353.177, FourCC("npfl"))
    u = BlzCreateUnitWithSkin(p, FourCC("npfl"), -5439.8, -3458.5, 340.894, FourCC("npfl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nogm"), 6040.0, -1714.1, 124.620, FourCC("nogm"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000053_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsh"), 5923.0, -1917.0, 158.581, FourCC("nfsh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ners"), -5623.8, -3552.0, 341.833, FourCC("ners"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfov"), -5604.3, -3329.5, 340.910, FourCC("nfov"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000100_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrp"), -3851.3, -5903.9, 95.980, FourCC("ndrp"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogm"), -1714.1, -6040.0, 34.620, FourCC("nogm"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000041_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrp"), -4153.2, -5740.9, 59.650, FourCC("ndrp"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsh"), -1917.0, -5923.0, 68.581, FourCC("nfsh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 474.4, -2583.4, 116.000, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), -522.0, 2753.5, 294.740, FourCC("nsrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), 1377.1, 2871.6, 236.689, FourCC("nwzr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000068_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), -5896.6, -860.4, 7.912, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), -5894.3, -1015.6, 347.396, FourCC("nomg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000073_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrh"), -5889.4, 3946.9, 320.450, FourCC("ndrh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000105_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrh"), -6226.6, 1659.0, 286.400, FourCC("ndrh"))
    u = BlzCreateUnitWithSkin(p, FourCC("ners"), 3552.0, -5623.8, 71.833, FourCC("ners"))
    u = BlzCreateUnitWithSkin(p, FourCC("ners"), 3122.2, -5616.0, 91.891, FourCC("ners"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndrw"), -5950.4, -1184.9, 6.100, FourCC("ndrw"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), 1512.0, 2770.3, 192.142, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("npfl"), -3168.4, 5451.1, 263.177, FourCC("npfl"))
    u = BlzCreateUnitWithSkin(p, FourCC("npfl"), -3458.5, 5439.8, 250.894, FourCC("npfl"))
    u = BlzCreateUnitWithSkin(p, FourCC("ners"), -3552.0, 5623.8, 251.833, FourCC("ners"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfov"), -3329.5, 5604.3, 250.910, FourCC("nfov"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000109_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrp"), -5920.8, 3763.3, 346.014, FourCC("ndrp"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogm"), -6040.0, 1714.1, 304.620, FourCC("nogm"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000107_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrp"), -5740.1, 4030.0, 287.609, FourCC("ndrp"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), 3195.4, -1309.9, 153.572, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrm"), -6023.7, -741.8, 1.950, FourCC("ndrm"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000042_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsh"), -5923.0, 1917.0, 338.581, FourCC("nfsh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), -2709.4, -495.0, 31.984, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), -3100.5, 1489.0, 310.310, FourCC("nwzr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000074_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), 848.4, -2545.2, 107.393, FourCC("nsrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), 527.3, -2758.9, 114.740, FourCC("nsrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), -918.1, 5947.6, 277.912, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrh"), 6226.6, -1659.0, 106.400, FourCC("ndrh"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), 2963.5, -1614.8, 102.142, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrh"), 3947.1, 5899.5, 266.043, FourCC("ndrh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000063_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), 3104.0, -1516.1, 130.780, FourCC("nwzr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000075_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrp"), 3766.4, 5895.4, 287.561, FourCC("ndrp"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrp"), 4092.6, 5781.0, 253.820, FourCC("ndrp"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("npfl"), 3458.5, -5439.8, 70.894, FourCC("npfl"))
    u = BlzCreateUnitWithSkin(p, FourCC("npfl"), 3168.4, -5451.1, 83.177, FourCC("npfl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), -1073.3, 5945.3, 257.400, FourCC("nomg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000080_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 718.3, -2433.3, 116.000, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), 2651.2, 465.9, 211.984, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzg"), -623.1, 2601.9, 300.740, FourCC("nwzg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000010_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrw"), -1242.6, 6001.4, 276.100, FourCC("ndrw"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nhdc"), 2528.2, 800.9, 213.474, FourCC("nhdc"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -469.1, 2578.0, 296.000, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -713.0, 2427.9, 296.000, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), -1271.0, -2938.6, 63.572, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), 1224.4, 2969.0, 243.572, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), 6149.9, -1520.4, 92.211, FourCC("ngrk"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), -1520.4, -6149.9, 2.211, FourCC("ngrk"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndrh"), 1659.0, 6226.6, 196.400, FourCC("ndrh"))
    u = BlzCreateUnitWithSkin(p, FourCC("npfl"), 5451.1, 3168.4, 173.177, FourCC("npfl"))
    u = BlzCreateUnitWithSkin(p, FourCC("npfl"), 5439.8, 3458.5, 160.894, FourCC("npfl"))
    u = BlzCreateUnitWithSkin(p, FourCC("ners"), 5623.8, 3552.0, 161.833, FourCC("ners"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfov"), 5604.3, 3329.5, 160.910, FourCC("nfov"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000034_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), -6149.9, 1520.4, 272.211, FourCC("ngrk"))
    u = BlzCreateUnitWithSkin(p, FourCC("nogm"), 1714.1, 6040.0, 214.620, FourCC("nogm"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000083_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), -1428.8, -2846.5, 56.689, FourCC("nwzr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000017_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsh"), 1917.0, 5923.0, 248.581, FourCC("nfsh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ners"), -5616.0, -3122.2, 1.891, FourCC("ners"))
    u = BlzCreateUnitWithSkin(p, FourCC("ners"), 5616.0, 3122.2, 181.891, FourCC("ners"))
    u = BlzCreateUnitWithSkin(p, FourCC("ners"), -3122.2, 5616.0, 271.891, FourCC("ners"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndrm"), -799.5, 6074.7, 271.950, FourCC("ndrm"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000069_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), 899.6, -5990.3, 97.912, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrw"), 5966.1, 1228.3, 186.100, FourCC("ndrw"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), 1054.8, -5987.9, 77.396, FourCC("nomg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000015_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), 5910.0, 1059.0, 167.396, FourCC("nomg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000016_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrm"), 6039.4, 785.2, 181.950, FourCC("ndrm"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000079_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrw"), 1224.1, -6044.0, 96.100, FourCC("ndrw"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzg"), 628.4, -2607.3, 120.740, FourCC("nwzg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000056_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), 5912.3, 903.8, 187.912, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrh"), 5895.0, -4008.7, 140.450, FourCC("ndrh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000091_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrp"), 5926.4, -3825.2, 166.014, FourCC("ndrp"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrp"), 5745.7, -4091.8, 107.609, FourCC("ndrp"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndrm"), 781.0, -6117.4, 91.950, FourCC("ndrm"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000002_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrn"), -2649.8, -640.3, 36.171, FourCC("nsrn"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000020_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), 1520.4, 6149.9, 182.211, FourCC("ngrk"))
    u = BlzCreateUnitWithSkin(p, FourCC("nhdc"), -2803.2, -555.9, 37.883, FourCC("nhdc"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nhdc"), -2586.4, -830.1, 33.474, FourCC("nhdc"))
    SetUnitAcquireRange(u, 200.0)
end
...
function CreateNeutralPassiveBuildings()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 3328.0, -5888.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 14000)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -5888.0, -3328.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 14000)
    u = BlzCreateUnitWithSkin(p, FourCC("ndh1"), 1408.0, -2304.0, 270.000, FourCC("ndh1"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), 768.0, -2816.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("nmrk"), 2816.0, 768.0, 270.000, FourCC("nmrk"))
    SetUnitColor(u, ConvertPlayerColor(0))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 6208.0, -1920.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12000)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -1920.0, -6208.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12000)
    u = BlzCreateUnitWithSkin(p, FourCC("ngad"), 1024.0, -6208.0, 270.000, FourCC("ngad"))
    u = BlzCreateUnitWithSkin(p, FourCC("nmer"), -6144.0, -1024.0, 270.000, FourCC("nmer"))
    SetUnitColor(u, ConvertPlayerColor(0))
    u = BlzCreateUnitWithSkin(p, FourCC("ngad"), -1024.0, 6208.0, 270.000, FourCC("ngad"))
    u = BlzCreateUnitWithSkin(p, FourCC("nmer"), 6144.0, 1024.0, 270.000, FourCC("nmer"))
    SetUnitColor(u, ConvertPlayerColor(0))
    ...
    SetUnitColor(u, ConvertPlayerColor(0))
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), -768.0, 2816.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndch"), 6016.0, -3456.0, 270.000, FourCC("ndch"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 1920.0, 6208.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12000)
    u = BlzCreateUnitWithSkin(p, FourCC("ndh1"), -6016.0, 3456.0, 270.000, FourCC("ndh1"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndch"), 2304.0, 1344.0, 270.000, FourCC("ndch"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndh0"), -1408.0, 2304.0, 270.000, FourCC("ndh0"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndh1"), -4608.0, -5504.0, 270.000, FourCC("ndh1"))
end
...
function CreateNeutralPassive()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("npig"), 939.2, -4950.1, 185.290, FourCC("npig"))
    u = BlzCreateUnitWithSkin(p, FourCC("npig"), 5100.2, -3539.9, 358.220, FourCC("npig"))
    u = BlzCreateUnitWithSkin(p, FourCC("npig"), 5050.3, 1188.9, 242.443, FourCC("npig"))
    u = BlzCreateUnitWithSkin(p, FourCC("npig"), 3573.8, 4847.1, 208.494, FourCC("npig"))
    u = BlzCreateUnitWithSkin(p, FourCC("npig"), -1134.0, 4987.1, 264.680, FourCC("npig"))
    u = BlzCreateUnitWithSkin(p, FourCC("npig"), -4885.4, 3592.0, 205.549, FourCC("npig"))
    u = BlzCreateUnitWithSkin(p, FourCC("npig"), -4817.9, -1081.8, 298.991, FourCC("npig"))
    u = BlzCreateUnitWithSkin(p, FourCC("npig"), -3557.4, -4843.0, 101.022, FourCC("npig"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndwm"), -814.4, -5129.0, 176.512, FourCC("ndwm"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndwm"), 4772.9, -846.3, 84.520, FourCC("ndwm"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndwm"), 834.5, 4972.7, 160.988, FourCC("ndwm"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndwm"), -4809.1, 914.9, 36.652, FourCC("ndwm"))
    u = BlzCreateUnitWithSkin(p, FourCC("nshe"), -2266.2, 759.1, 218.019, FourCC("nshe"))
    u = BlzCreateUnitWithSkin(p, FourCC("nshe"), 985.3, 2139.1, 200.880, FourCC("nshe"))
    u = BlzCreateUnitWithSkin(p, FourCC("nshe"), 2417.5, -935.7, 304.737, FourCC("nshe"))
    u = BlzCreateUnitWithSkin(p, FourCC("nshe"), -867.8, -2143.1, 282.225, FourCC("nshe"))
    u = BlzCreateUnitWithSkin(p, FourCC("nvul"), 337.7, 379.0, 43.189, FourCC("nvul"))
    u = BlzCreateUnitWithSkin(p, FourCC("nvul"), -331.3, -334.7, 74.929, FourCC("nvul"))
    u = BlzCreateUnitWithSkin(p, FourCC("nvul"), -425.1, -4774.9, 311.604, FourCC("nvul"))
    u = BlzCreateUnitWithSkin(p, FourCC("nvul"), 424.4, 4790.4, 75.270, FourCC("nvul"))
    u = BlzCreateUnitWithSkin(p, FourCC("nvul"), -3694.1, 2272.7, 235.301, FourCC("nvul"))
    u = BlzCreateUnitWithSkin(p, FourCC("nvul"), 3772.1, -1804.4, 261.032, FourCC("nvul"))
end
...
function CreateRegions()
    local we
    gg_rct_Fog2 = Rect(2080.0, 3360.0, 2592.0, 4064.0)
    we = AddWeatherEffect(gg_rct_Fog2, FourCC("FDrh"))
    EnableWeatherEffect(we, true)
    gg_rct_Fog3 = Rect(1664.0, 3040.0, 2176.0, 3744.0)
    we = AddWeatherEffect(gg_rct_Fog3, FourCC("FDrh"))
    EnableWeatherEffect(we, true)
    gg_rct_Fog4 = Rect(1792.0, 3712.0, 2144.0, 4064.0)
    we = AddWeatherEffect(gg_rct_Fog4, FourCC("FDrh"))
    EnableWeatherEffect(we, true)
    gg_rct_Fog2_Copy = Rect(-2560.0, -4160.0, -2048.0, -3456.0)
    we = AddWeatherEffect(gg_rct_Fog2_Copy, FourCC("FDrh"))
    EnableWeatherEffect(we, true)
    gg_rct_Fog3_Copy = Rect(-2144.0, -3840.0, -1632.0, -3136.0)
    we = AddWeatherEffect(gg_rct_Fog3_Copy, FourCC("FDrh"))
    EnableWeatherEffect(we, true)
    gg_rct_Fog4_Copy = Rect(-2112.0, -4160.0, -1760.0, -3808.0)
    we = AddWeatherEffect(gg_rct_Fog4_Copy, FourCC("FDrh"))
    EnableWeatherEffect(we, true)
    gg_rct_Moonlight = Rect(-32.0, -128.0, 96.0, 0.0)
...
function main()
    SetCameraBounds(-7552.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), -7552.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 7552.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 7552.0 - GetCameraMargin(CAMERA_MARGIN_TOP), -7552.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 7552.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 7552.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), -7552.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
    SetDayNightModels("Environment\\DNC\\DNCAshenvale\\DNCAshenvaleTerrain\\DNCAshenvaleTerrain.mdl", "Environment\\DNC\\DNCAshenvale\\DNCAshenvaleUnit\\DNCAshenvaleUnit.mdl")
    SetTerrainFogEx(0, 3000.0, 5000.0, 0.500, 1.000, 1.000, 0.000)
...
function config()
    ...
    DefineStartLocation(0, 3328.0, -5120.0)
    DefineStartLocation(1, -5120.0, -3328.0)
    DefineStartLocation(2, -3328.0, 5120.0)
    DefineStartLocation(3, 5120.0, 3328.0)
