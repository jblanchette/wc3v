...
function ItemTable000000_DropItems()
    ...
    if (canDrop) then
        RandomDistReset()
        RandomDistAddItem(FourCC("rej3"), 34)
        RandomDistAddItem(FourCC("wswd"), 33)
        RandomDistAddItem(FourCC("will"), 33)
...
function CreateNeutralHostile()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nowb"), 1263.2, -5866.5, 73.718, FourCC("nowb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000027_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), -5581.2, -1870.0, 28.688, FourCC("ncen"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000015_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nkog"), -4356.8, -4029.4, 61.070, FourCC("nkog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkog"), 4390.8, 4059.3, 241.070, FourCC("nkog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -4459.5, 4180.2, 348.604, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 238.7, -3745.7, 135.660, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncks"), 5661.6, 1668.0, 200.914, FourCC("ncks"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000101_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), -5951.2, 1429.4, 358.598, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), 5589.8, 1857.3, 241.274, FourCC("ncen"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000089_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -274.1, 3753.9, 315.660, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncea"), 5838.7, 1600.2, 182.452, FourCC("ncea"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncea"), -5830.1, -1612.9, 0.335, FourCC("ncea"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncea"), 1618.4, 5824.6, 270.448, FourCC("ncea"))
    u = BlzCreateUnitWithSkin(p, FourCC("nqbh"), -2553.1, -2250.9, 24.582, FourCC("nqbh"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncks"), -1695.4, -5636.0, 55.111, FourCC("ncks"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000031_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ncim"), 1099.0, -1154.0, 125.386, FourCC("ncim"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000047_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nqbh"), -2234.0, -2551.2, 70.988, FourCC("nqbh"))
    u = BlzCreateUnitWithSkin(p, FourCC("nkog"), 4061.6, 4328.5, 253.740, FourCC("nkog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzg"), -2189.3, -2199.4, 39.920, FourCC("nrzg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000065_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ncea"), -1911.7, 1629.5, 131.360, FourCC("ncea"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), 1468.1, -5913.9, 113.251, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), 5993.8, -1445.1, 176.680, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), 5803.6, -1080.2, 237.130, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzb"), -2364.1, -2154.4, 29.337, FourCC("nrzb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), -4219.8, -3976.5, 36.588, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), -1883.8, -5561.3, 24.877, FourCC("ncen"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000016_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ncim"), 1637.5, -1898.6, 311.380, FourCC("ncim"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncea"), -1624.8, -5820.9, 77.198, FourCC("ncea"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncer"), 1158.5, -982.5, 160.543, FourCC("ncer"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncer"), 953.5, -1214.9, 100.705, FourCC("ncer"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), 1877.5, 5565.0, 225.350, FourCC("ncen"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000098_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzg"), 2201.1, 2191.5, 219.920, FourCC("nrzg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), -1927.2, 1798.8, 134.985, FourCC("ncen"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncks"), 1689.0, 5639.7, 258.694, FourCC("ncks"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000093_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nkol"), -4076.7, -3995.2, 62.850, FourCC("nkol"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkot"), -3997.5, -4148.4, 71.326, FourCC("nkot"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), 1926.7, -1789.6, 290.490, FourCC("ncen"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nowb"), -5901.7, 1239.3, 23.605, FourCC("nowb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), 51.5, -3833.5, 121.150, FourCC("ntrt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncim"), -1645.1, 1963.2, 134.708, FourCC("ncim"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), -1056.6, 5790.0, 251.130, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), -5791.2, 1090.9, 29.848, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -3713.6, 289.5, 289.614, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), -1436.0, 5941.9, 253.417, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkog"), -4027.6, -4298.5, 73.740, FourCC("nkog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nowb"), 5907.4, -1274.2, 207.350, FourCC("nowb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000070_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nqbh"), 2551.4, 2208.3, 204.582, FourCC("nqbh"))
    u = BlzCreateUnitWithSkin(p, FourCC("nkol"), 4112.9, 4020.9, 242.850, FourCC("nkol"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000049_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), 4253.8, 4006.4, 216.588, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), 1076.4, -5804.5, 38.498, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkot"), 4031.6, 4178.4, 251.326, FourCC("nkot"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncks"), -1828.8, 1946.3, 136.250, FourCC("ncks"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000099_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ncks"), -5653.0, -1680.6, 7.468, FourCC("ncks"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000091_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrh"), 82.1, 3944.3, 295.230, FourCC("ntrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrh"), 3972.3, 92.0, 153.195, FourCC("ntrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrh"), -127.6, -3896.4, 79.270, FourCC("ntrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncks"), 1814.8, -1913.2, 304.570, FourCC("ncks"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000080_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), -120.8, 3884.9, 299.240, FourCC("ntrt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000108_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nkot"), -1156.1, 1033.1, 333.150, FourCC("nkot"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 3684.2, -213.0, 135.659, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nowb"), -1229.7, 5877.9, 251.073, FourCC("nowb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000007_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrh"), -3988.4, -51.7, 346.597, FourCC("ntrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkog"), -1009.7, 1090.6, 287.419, FourCC("nkog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), -3854.5, 110.3, 319.870, FourCC("ntrt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000051_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ncea"), 1929.9, -1598.0, 305.853, FourCC("ncea"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), -1212.3, 895.4, 356.451, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzb"), -2161.6, -2380.5, 58.219, FourCC("nrzb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nqbh"), 2190.3, 2502.3, 250.988, FourCC("nqbh"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrzb"), 2402.6, 2115.7, 209.337, FourCC("nrzb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzb"), 2119.4, 2370.2, 238.219, FourCC("nrzb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), 3838.9, -83.9, 144.590, FourCC("ntrt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
...
function CreateNeutralPassiveBuildings()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -4544.0, 4544.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 10000)
    u = BlzCreateUnitWithSkin(p, FourCC("nmr0"), -4224.0, -4224.0, 270.000, FourCC("nmr0"))
...
function CreateNeutralPassive()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nrat"), -6209.7, 3317.3, 43.804, FourCC("nrat"))
    u = BlzCreateUnitWithSkin(p, FourCC("nvul"), 8.2, -66.3, 201.300, FourCC("nvul"))
    u = BlzCreateUnitWithSkin(p, FourCC("n001"), 4283.9, 5345.6, 237.820, FourCC("n001"))
    u = BlzCreateUnitWithSkin(p, FourCC("n000"), -5234.7, -4788.7, 35.461, FourCC("n000"))
