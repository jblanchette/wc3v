...
function CreateRegions()
    ...
    EnableWeatherEffect(we, true)
    gg_rct_Rain6 = Rect(-3680.0, 576.0, -2368.0, 2112.0)
    we = AddWeatherEffect(gg_rct_Rain6, FourCC("RLlr"))
    EnableWeatherEffect(we, true)
    gg_rct_Rain7 = Rect(-6048.0, 512.0, -3616.0, 2080.0)
    we = AddWeatherEffect(gg_rct_Rain7, FourCC("RLlr"))
    EnableWeatherEffect(we, true)
    gg_rct_Rain8 = Rect(-10112.0, -1088.0, -5472.0, 2272.0)
    we = AddWeatherEffect(gg_rct_Rain8, FourCC("RLlr"))
    EnableWeatherEffect(we, true)
...
function main()
    ...
    SetTerrainFogEx(0, 1500.0, 5000.0, 0.500, 0.000, 0.784, 1.000)
