...
function CreateNeutralHostile()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 1793.6, -916.1, 106.737, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -6479.9, -4394.4, 314.500, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000010_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nbrg"), -6436.6, -4228.2, 292.292, FourCC("nbrg"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nbrg"), -6642.0, -4377.0, 329.044, FourCC("nbrg"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), -2739.7, -4508.3, 215.188, FourCC("nban"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), -2403.6, -4633.9, 239.040, FourCC("nwzr"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nenf"), -2565.2, -4618.5, 225.800, FourCC("nenf"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000015_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -2473.9, -4810.5, 243.069, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -3625.7, -6712.4, 54.266, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), -2539.8, -4451.6, 216.040, FourCC("nass"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000014_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -3452.9, -6792.9, 83.060, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000019_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrl"), -3660.8, -6557.5, 30.575, FourCC("nmrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrl"), -3314.8, -6723.7, 106.049, FourCC("nmrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), 1740.4, 1281.5, 296.294, FourCC("nomg"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -4394.4, 6479.9, 224.500, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000057_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nbrg"), -4228.2, 6436.6, 202.291, FourCC("nbrg"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nbrg"), -4377.0, 6642.0, 239.044, FourCC("nbrg"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), -4633.9, 2403.6, 149.040, FourCC("nwzr"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), -4451.6, 2539.8, 126.040, FourCC("nass"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000061_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nenf"), -4618.5, 2565.2, 135.800, FourCC("nenf"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000062_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -4810.5, 2473.9, 153.069, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), -4508.3, 2739.7, 125.188, FourCC("nban"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -6712.4, 3625.7, 324.267, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -6792.9, 3452.9, 353.060, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000066_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrl"), -6557.5, 3660.8, 300.575, FourCC("nmrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrl"), -6723.7, 3314.8, 16.049, FourCC("nmrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsqo"), -383.1, 6041.0, 251.030, FourCC("nsqo"))
    SetUnitState(u, UNIT_STATE_MANA, 500)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000069_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnw"), -3950.9, -414.5, 225.800, FourCC("ngnw"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nkot"), -6387.3, -3034.6, 46.754, FourCC("nkot"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkot"), -6138.1, -3289.3, 61.171, FourCC("nkot"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkog"), -6216.5, -3098.8, 77.650, FourCC("nkog"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), -6275.1, -2953.8, 65.964, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), -6098.1, -3156.1, 58.388, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogr"), 1939.3, 1333.3, 265.531, FourCC("nogr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000214_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 1591.3, 1267.7, 316.917, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 1815.9, 1447.0, 279.644, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogr"), 1649.7, 1110.5, 326.790, FourCC("nogr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 916.1, 1793.6, 196.737, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), -4088.3, -251.4, 207.220, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000076_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nsqo"), -6041.0, -383.1, 341.030, FourCC("nsqo"))
    SetUnitState(u, UNIT_STATE_MANA, 500)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000022_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), -5906.0, -226.6, 352.757, FourCC("ngrk"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), -6038.4, -567.7, 326.072, FourCC("ngrk"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), -6120.6, -211.6, 344.290, FourCC("nftb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), -6209.4, -440.9, 329.980, FourCC("nftb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000028_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngns"), -3832.9, -595.2, 245.830, FourCC("ngns"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000071_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngno"), -3998.4, -530.6, 234.702, FourCC("ngno"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngno"), -4091.8, -426.5, 207.972, FourCC("ngno"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), -3951.7, -246.0, 193.614, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnw"), -414.5, 3950.9, 135.800, FourCC("ngnw"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), -251.4, 4088.3, 117.220, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000077_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), -226.6, 5906.0, 262.757, FourCC("ngrk"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), -211.6, 6120.6, 254.290, FourCC("nftb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), -440.9, 6209.4, 239.980, FourCC("nftb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000075_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngns"), -595.2, 3832.9, 155.830, FourCC("ngns"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000050_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), -567.7, 6038.4, 236.072, FourCC("ngrk"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("ngno"), -530.6, 3998.4, 144.702, FourCC("ngno"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), -947.2, -6617.4, 159.224, FourCC("nfsp"))
    SetUnitState(u, UNIT_STATE_MANA, 200)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), -1032.5, -6786.8, 124.360, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000040_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), -1176.5, -6851.3, 107.435, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), 824.7, 1512.1, 125.520, FourCC("nban"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), 906.7, 1636.6, 159.910, FourCC("nwzr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000220_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), -1636.6, 906.7, 249.910, FourCC("nwzr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000221_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngno"), -426.5, 4091.8, 117.972, FourCC("ngno"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), -246.0, 3951.7, 103.614, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), -1512.1, 824.7, 215.520, FourCC("nban"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -1793.6, 916.1, 286.737, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogr"), -1110.5, 1649.7, 56.790, FourCC("nogr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), -6851.3, 1176.5, 17.435, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), -6786.8, 1032.5, 34.360, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000087_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), -6617.4, 947.2, 69.224, FourCC("nfsp"))
    SetUnitState(u, UNIT_STATE_MANA, 200)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkot"), -3034.6, 6387.3, 316.755, FourCC("nkot"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkot"), -3289.3, 6138.1, 331.171, FourCC("nkot"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkog"), -3098.8, 6216.5, 347.650, FourCC("nkog"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), -2953.8, 6275.1, 335.964, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), -3156.1, 6098.1, 328.388, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -1447.0, 1815.9, 9.644, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -1267.7, 1599.3, 46.917, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogr"), -1333.3, 1939.3, 355.531, FourCC("nogr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000227_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), -1281.5, 1740.4, 26.294, FourCC("nomg"))
    SetUnitState(u, UNIT_STATE_MANA, 400)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 6479.9, 4394.4, 134.500, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000104_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nbrg"), 6436.6, 4228.2, 112.291, FourCC("nbrg"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nbrg"), 6642.0, 4377.0, 149.044, FourCC("nbrg"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), 2403.6, 4633.9, 59.040, FourCC("nwzr"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), 2539.8, 4451.6, 36.040, FourCC("nass"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000108_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nenf"), 2565.2, 4618.5, 45.800, FourCC("nenf"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000109_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 2473.9, 4810.5, 63.069, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), 2739.7, 4508.3, 35.188, FourCC("nban"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), 3625.7, 6712.4, 234.267, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), 3452.9, 6792.9, 263.060, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000113_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrl"), 3660.8, 6557.5, 210.575, FourCC("nmrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrl"), 3314.8, 6723.7, 286.049, FourCC("nmrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsqo"), 6041.0, 383.1, 161.030, FourCC("nsqo"))
    SetUnitState(u, UNIT_STATE_MANA, 500)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000116_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnw"), 3950.9, 350.5, 45.800, FourCC("ngnw"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), 4088.3, 187.4, 27.220, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000132_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), 5906.0, 226.6, 172.757, FourCC("ngrk"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), 6120.6, 211.6, 164.290, FourCC("nftb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), 6209.4, 440.9, 149.980, FourCC("nftb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000122_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngns"), 3832.9, 531.2, 65.830, FourCC("ngns"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000130_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), 6038.4, 567.7, 146.072, FourCC("ngrk"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("ngno"), 3998.4, 466.6, 54.702, FourCC("ngno"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngno"), 4091.8, 362.5, 27.972, FourCC("ngno"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), 3951.7, 182.0, 13.614, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), -1740.4, -1281.5, 116.294, FourCC("nomg"))
    SetUnitState(u, UNIT_STATE_MANA, 400)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nogr"), -1939.3, -1333.3, 85.531, FourCC("nogr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000232_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -1599.3, -1267.7, 136.917, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), 1176.5, 6851.3, 287.435, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), 1032.5, 6786.8, 304.360, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000134_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), 947.2, 6617.4, 339.224, FourCC("nfsp"))
    SetUnitState(u, UNIT_STATE_MANA, 200)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkot"), 6387.3, 3034.6, 226.755, FourCC("nkot"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkot"), 6138.1, 3289.3, 241.171, FourCC("nkot"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkog"), 6216.5, 3098.8, 257.650, FourCC("nkog"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), 6275.1, 2953.8, 245.964, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), 6098.1, 3156.1, 238.388, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -1815.9, -1447.0, 99.644, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogr"), -1649.7, -1110.5, 146.790, FourCC("nogr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -916.1, -1793.6, 16.737, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), -824.7, -1512.1, 305.520, FourCC("nban"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), -906.7, -1636.6, 339.910, FourCC("nwzr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000094_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 1267.7, -1599.3, 226.917, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 4394.4, -6479.9, 44.500, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000151_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nbrg"), 4228.2, -6436.6, 22.291, FourCC("nbrg"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nbrg"), 4377.0, -6642.0, 59.044, FourCC("nbrg"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), 4633.9, -2403.6, 329.040, FourCC("nwzr"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), 4451.6, -2539.8, 306.040, FourCC("nass"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000155_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nenf"), 4618.5, -2565.2, 315.800, FourCC("nenf"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000156_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 4810.5, -2473.9, 333.069, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), 4508.3, -2739.7, 305.188, FourCC("nban"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), 6712.4, -3625.7, 144.266, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), 6792.9, -3452.9, 173.060, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000160_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrl"), 6557.5, -3660.8, 120.575, FourCC("nmrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrl"), 6723.7, -3314.8, 196.049, FourCC("nmrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsqo"), 383.1, -6041.0, 71.030, FourCC("nsqo"))
    SetUnitState(u, UNIT_STATE_MANA, 500)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000163_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnw"), 414.5, -3950.9, 315.800, FourCC("ngnw"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), 251.4, -4088.3, 297.220, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000166_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), 226.6, -5906.0, 82.757, FourCC("ngrk"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), 211.6, -6120.6, 74.290, FourCC("nftb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), 440.9, -6209.4, 59.980, FourCC("nftb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000169_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngns"), 595.2, -3832.9, 335.830, FourCC("ngns"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000171_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), 567.7, -6038.4, 56.072, FourCC("ngrk"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("ngno"), 530.6, -3998.4, 324.702, FourCC("ngno"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngno"), 426.5, -4091.8, 297.972, FourCC("ngno"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), 246.0, -3951.7, 283.614, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), 1512.1, -824.7, 35.520, FourCC("nban"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), 1636.6, -906.7, 69.910, FourCC("nwzr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000008_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), 6851.3, -1176.5, 197.435, FourCC("nftr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), 6786.8, -1032.5, 214.360, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000181_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), 6617.4, -947.2, 249.224, FourCC("nfsp"))
    SetUnitState(u, UNIT_STATE_MANA, 200)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkot"), 3034.6, -6387.3, 136.755, FourCC("nkot"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkot"), 3289.3, -6138.1, 151.171, FourCC("nkot"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkog"), 3098.8, -6216.5, 167.650, FourCC("nkog"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), 2953.8, -6275.1, 155.964, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), 3156.1, -6098.1, 148.388, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 1447.0, -1815.9, 189.644, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogr"), 1110.5, -1649.7, 236.790, FourCC("nogr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogr"), 1333.3, -1939.3, 175.531, FourCC("nogr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000049_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), 1281.5, -1740.4, 206.294, FourCC("nomg"))
    SetUnitState(u, UNIT_STATE_MANA, 400)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nbld"), -6209.9, 5885.8, 343.590, FourCC("nbld"))
    SetUnitState(u, UNIT_STATE_MANA, 500)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000193_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -6084.9, 6086.2, 358.445, FourCC("nrog"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -6185.6, 5640.4, 329.709, FourCC("nrog"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), -6398.9, 5930.1, 344.902, FourCC("nwzr"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("nbld"), -5885.8, -6209.9, 73.590, FourCC("nbld"))
    SetUnitState(u, UNIT_STATE_MANA, 500)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000199_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), -6370.8, 5739.0, 323.993, FourCC("nass"))
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), -6293.9, 6106.1, 16.361, FourCC("nass"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -6086.2, -6084.9, 88.445, FourCC("nrog"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -5640.4, -6185.6, 59.709, FourCC("nrog"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), -5930.1, -6398.9, 74.902, FourCC("nwzr"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), -6106.1, -6293.9, 106.361, FourCC("nass"))
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), -5739.0, -6370.8, 53.993, FourCC("nass"))
    u = BlzCreateUnitWithSkin(p, FourCC("nbld"), 6209.9, -5885.8, 163.590, FourCC("nbld"))
    SetUnitState(u, UNIT_STATE_MANA, 500)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000205_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 6084.9, -6086.2, 178.445, FourCC("nrog"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 6185.6, -5640.4, 149.709, FourCC("nrog"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), 6398.9, -5930.1, 164.902, FourCC("nwzr"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), 6293.9, -6106.1, 196.361, FourCC("nass"))
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), 6370.8, -5739.0, 143.993, FourCC("nass"))
    u = BlzCreateUnitWithSkin(p, FourCC("nbld"), 5885.8, 6209.9, 253.590, FourCC("nbld"))
    SetUnitState(u, UNIT_STATE_MANA, 500)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000211_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 6086.2, 6084.9, 268.445, FourCC("nrog"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 5640.4, 6185.6, 239.709, FourCC("nrog"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), 5930.1, 6398.9, 254.902, FourCC("nwzr"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), 6106.1, 6293.9, 286.361, FourCC("nass"))
    u = BlzCreateUnitWithSkin(p, FourCC("nass"), 5739.0, 6370.8, 233.993, FourCC("nass"))
end
...
function CreateNeutralPassiveBuildings()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -5888.0, -6656.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 11500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -2304.0, -4352.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 9000)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -6400.0, -256.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngad"), 1600.0, 1536.0, 270.000, FourCC("ngad"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), -6400.0, -3328.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -6656.0, 5888.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 11500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -4352.0, 2304.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 9000)
    u = BlzCreateUnitWithSkin(p, FourCC("nmr2"), -3776.0, -256.0, 270.000, FourCC("nmr2"))
    SetUnitColor(u, ConvertPlayerColor(12))
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), -3328.0, 6400.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -256.0, 6400.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("nmr2"), -256.0, 3776.0, 270.000, FourCC("nmr2"))
    SetUnitColor(u, ConvertPlayerColor(12))
    u = BlzCreateUnitWithSkin(p, FourCC("nmh0"), -3552.0, -7008.0, 270.000, FourCC("nmh0"))
    u = BlzCreateUnitWithSkin(p, FourCC("nmh0"), -7008.0, 3552.0, 270.000, FourCC("nmh0"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngad"), -1536.0, 1600.0, 270.000, FourCC("ngad"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 5888.0, 6656.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 11500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 2304.0, 4352.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 9000)
    u = BlzCreateUnitWithSkin(p, FourCC("nmr2"), 3776.0, 192.0, 270.000, FourCC("nmr2"))
    SetUnitColor(u, ConvertPlayerColor(12))
    u = BlzCreateUnitWithSkin(p, FourCC("ngad"), -1600.0, -1536.0, 270.000, FourCC("ngad"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), 6400.0, 3328.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 6400.0, 256.0, 270.000, FourCC("ngol"))
...
function CreateNeutralPassive()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nrac"), -5282.8, -4598.7, 221.337, FourCC("nrac"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrac"), -4672.5, 5068.8, 164.207, FourCC("nrac"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrac"), 5120.5, 5031.7, 33.037, FourCC("nrac"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrac"), 5316.2, -5307.9, 346.431, FourCC("nrac"))
    u = BlzCreateUnitWithSkin(p, FourCC("necr"), 4905.9, -2856.5, 55.636, FourCC("necr"))
    u = BlzCreateUnitWithSkin(p, FourCC("necr"), -2845.3, -4803.8, 158.988, FourCC("necr"))
    u = BlzCreateUnitWithSkin(p, FourCC("necr"), -4866.4, 2860.4, 149.638, FourCC("necr"))
    u = BlzCreateUnitWithSkin(p, FourCC("necr"), 2961.5, 4721.8, 329.622, FourCC("necr"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndog"), -654.8, 4952.1, 13.525, FourCC("ndog"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndog"), -5018.2, -662.5, 96.880, FourCC("ndog"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndog"), 556.1, -5186.6, 174.336, FourCC("ndog"))
    u = BlzCreateUnitWithSkin(p, FourCC("ndog"), 5037.8, 588.8, 148.430, FourCC("ndog"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), 41.8, -2423.4, 71.787, FourCC("nfro"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), -2523.2, -71.2, 199.397, FourCC("nfro"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), -158.6, 2377.8, 256.165, FourCC("nfro"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), 2346.4, 75.9, 49.715, FourCC("nfro"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), -2367.4, -7052.5, 103.264, FourCC("nfro"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), -7027.5, 2404.9, 276.633, FourCC("nfro"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), 2414.1, 7014.2, 98.408, FourCC("nfro"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), 7004.9, -2312.6, 7.779, FourCC("nfro"))
    u = BlzCreateUnitWithSkin(p, FourCC("necr"), -320.6, -452.9, 11.338, FourCC("necr"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrac"), 544.1, 345.7, 13.700, FourCC("nrac"))
end
...
function main()
    ...
    SetTerrainFogEx(0, 1500.0, 5000.0, 0.500, 0.831, 0.369, 0.098)
    we = AddWeatherEffect(Rect(-10240.0, -10240.0, 10240.0, 10240.0), FourCC("RLlr"))
...
function config()
    ...
    DefineStartLocation(0, 5888.0, -5888.0)
    DefineStartLocation(1, -5888.0, -5888.0)
    DefineStartLocation(2, -5888.0, 5888.0)
    DefineStartLocation(3, 5888.0, 5888.0)
