...
function CreateNeutralHostile()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nnwr"), -8472.9, -566.0, 34.611, FourCC("nnwr"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nith"), 103.1, 3184.1, 43.314, FourCC("nith"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrvs"), -4876.5, -4933.7, 91.170, FourCC("nrvs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nnwq"), -8469.5, -90.2, 34.036, FourCC("nnwq"))
    IssueImmediateOrder(u, "raisedeadoff")
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000099_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), -8212.0, -2180.6, 293.158, FourCC("nnwl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nspd"), 1223.5, 8352.2, 291.409, FourCC("nspd"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrvs"), -5070.5, -4439.0, 91.170, FourCC("nrvs"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nskm"), -8776.5, -3530.6, 330.701, FourCC("nskm"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nska"), -371.8, -8764.7, 134.993, FourCC("nska"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nskm"), -8889.7, -3917.3, 9.166, FourCC("nskm"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), -8568.1, -3588.4, 322.866, FourCC("nwwf"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nspd"), -2682.3, -9297.0, 98.665, FourCC("nspd"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpc"), -150.4, -2533.2, 45.990, FourCC("nfpc"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000027_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nith"), -1511.1, -4080.1, 223.314, FourCC("nith"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), -9337.3, 6403.5, 306.560, FourCC("nnwl"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000181_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpu"), -1475.1, 1740.9, 249.400, FourCC("nfpu"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000213_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfps"), -1069.7, 1697.4, 224.812, FourCC("nfps"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfps"), -338.3, -2593.4, 44.812, FourCC("nfps"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpc"), -1257.6, 1637.2, 225.990, FourCC("nfpc"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000052_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nith"), -1005.7, 1902.3, 231.850, FourCC("nith"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -7206.8, 8707.2, 306.459, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -3462.4, -6734.3, 259.312, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), -6349.5, -6431.1, 18.944, FourCC("nwwf"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nska"), -774.6, -8911.3, 114.058, FourCC("nska"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), -9123.5, -7305.1, 52.936, FourCC("nwwf"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), -73.9, 3392.7, 352.051, FourCC("nits"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), 388.1, 3138.0, 42.371, FourCC("nits"))
    u = BlzCreateUnitWithSkin(p, FourCC("nplg"), 3268.7, 3547.2, 182.120, FourCC("nplg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000255_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwd"), -1653.4, -4276.2, 227.447, FourCC("nwwd"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000034_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwg"), -1888.7, -4255.0, 248.718, FourCC("nwwg"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), 7936.6, -7293.9, 137.520, FourCC("nnwl"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000165_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwg"), -1580.2, -4496.3, 223.231, FourCC("nwwg"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), -1334.1, -4288.7, 172.051, FourCC("nits"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), -1796.1, -4034.0, 222.371, FourCC("nits"))
    u = BlzCreateUnitWithSkin(p, FourCC("nitw"), 527.3, -4350.2, 329.780, FourCC("nitw"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000084_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nith"), 635.2, -4062.1, 302.693, FourCC("nith"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwwg"), 172.2, 3600.3, 43.231, FourCC("nwwg"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), 293.5, -4337.8, 337.901, FourCC("nits"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), 551.5, -4545.4, 350.109, FourCC("nits"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwwg"), 480.7, 3359.0, 68.718, FourCC("nwwg"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), 728.9, -4270.9, 307.108, FourCC("nits"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwwd"), 245.4, 3380.2, 47.447, FourCC("nwwd"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000145_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nitw"), -1935.3, 3454.2, 149.780, FourCC("nitw"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000146_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nith"), -2043.2, 3166.1, 122.693, FourCC("nith"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), -1701.5, 3441.8, 157.901, FourCC("nits"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), -1959.5, 3649.4, 170.109, FourCC("nits"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), -2136.9, 3374.9, 127.108, FourCC("nits"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 5788.0, -9607.9, 109.241, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), 4706.7, 5762.1, 224.523, FourCC("nwwf"))
    u = BlzCreateUnitWithSkin(p, FourCC("nitp"), 5160.0, 5681.9, 202.789, FourCC("nitp"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), 4941.5, 5535.1, 198.944, FourCC("nwwf"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), 4943.5, 5792.4, 215.030, FourCC("nits"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000157_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nith"), 4865.2, 5993.8, 227.780, FourCC("nith"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000158_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nskm"), 7051.7, 8237.8, 232.294, FourCC("nskm"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), 7737.7, 6323.7, 220.715, FourCC("nwwf"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nmfs"), 5364.1, 8916.2, 245.826, FourCC("nmfs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), -8478.3, -2195.8, 309.460, FourCC("nnwl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), -8533.9, -2472.2, 326.448, FourCC("nnwl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwr"), -8716.5, -2328.0, 325.325, FourCC("nnwr"))
    IssueImmediateOrder(u, "autodispeloff")
    IssueImmediateOrder(u, "raisedeadoff")
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nnwq"), -8385.8, -1939.6, 296.678, FourCC("nnwq"))
    IssueImmediateOrder(u, "raisedeadoff")
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nplg"), -4686.8, -4494.4, 2.120, FourCC("nplg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000003_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), -8318.1, -469.9, 29.868, FourCC("nnwl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), -8426.3, -293.2, 39.661, FourCC("nnwl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), -8696.7, 17.6, 28.527, FourCC("nnwl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwr"), 7064.9, -330.0, 214.611, FourCC("nnwr"))
    IssueImmediateOrder(u, "autodispeloff")
    IssueImmediateOrder(u, "raisedeadoff")
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nnwq"), 7061.5, -805.8, 214.036, FourCC("nnwq"))
    IssueImmediateOrder(u, "raisedeadoff")
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000127_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), 6804.0, 1284.6, 113.158, FourCC("nnwl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), 7070.3, 1299.8, 129.460, FourCC("nnwl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), 7125.9, 1576.2, 146.448, FourCC("nnwl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwr"), 7308.5, 1432.0, 145.325, FourCC("nnwr"))
    IssueImmediateOrder(u, "autodispeloff")
    IssueImmediateOrder(u, "raisedeadoff")
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nnwq"), 6977.8, 1043.6, 116.678, FourCC("nnwq"))
    IssueImmediateOrder(u, "raisedeadoff")
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000132_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), 7288.7, -913.6, 208.527, FourCC("nnwl"))
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), -6351.5, -6688.4, 35.030, FourCC("nits"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000044_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), -6114.7, -6658.1, 44.523, FourCC("nwwf"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), 6910.1, -426.1, 209.868, FourCC("nnwl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), 7018.3, -602.8, 219.661, FourCC("nnwl"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwen"), -638.2, -8751.9, 124.821, FourCC("nwen"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwen"), -243.5, -8956.8, 133.178, FourCC("nwen"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwen"), -752.8, -9117.2, 111.206, FourCC("nwen"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwna"), -526.9, -8946.9, 123.897, FourCC("nwna"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000013_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -6366.2, 1339.0, 84.994, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), -9283.1, -7043.0, 15.039, FourCC("nwwf"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), 7961.2, 6081.9, 193.421, FourCC("nwwf"))
    SetUnitAcquireRange(u, 200.0)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrm"), -4870.8, -4368.8, 87.052, FourCC("nmrm"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nplg"), 3415.0, -4514.8, 177.880, FourCC("nplg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000227_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrm"), -4677.1, -4743.0, 326.621, FourCC("nmrm"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), 4834.7, -6658.1, 135.477, FourCC("nwwf"))
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), -9289.8, -7250.5, 29.050, FourCC("nnwl"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000002_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nitp"), 5288.0, -6577.9, 157.211, FourCC("nitp"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), 5069.5, -6431.1, 161.056, FourCC("nwwf"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), 5071.5, -6688.4, 144.970, FourCC("nits"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000173_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nith"), -6273.2, -6889.8, 47.780, FourCC("nith"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000046_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nitp"), -6568.0, -6577.9, 22.789, FourCC("nitp"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nith"), 4993.2, -6889.8, 132.220, FourCC("nith"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000174_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmfs"), -6768.9, -9813.9, 66.971, FourCC("nmfs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nskm"), 7170.4, -9139.6, 127.706, FourCC("nskm"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), 7794.5, -7339.6, 126.894, FourCC("nwwf"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nmfs"), 5492.0, -9824.4, 106.318, FourCC("nmfs"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), 7999.6, -7109.8, 138.454, FourCC("nwwf"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 5647.6, 8685.0, 248.217, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), -6242.7, 5762.1, 315.477, FourCC("nwwf"))
    u = BlzCreateUnitWithSkin(p, FourCC("nitp"), -6696.0, 5681.9, 337.211, FourCC("nitp"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), -6477.5, 5535.1, 341.056, FourCC("nwwf"))
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), -6479.5, 5792.4, 324.970, FourCC("nits"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000189_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nith"), -6401.2, 5993.8, 312.220, FourCC("nith"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000190_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nskm"), -8602.3, 8253.1, 307.706, FourCC("nskm"))
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), -9399.2, 6263.3, 302.461, FourCC("nwwf"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nmfs"), -6930.0, 8878.8, 266.457, FourCC("nmfs"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), -9178.9, 6420.1, 313.563, FourCC("nwwf"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrvs"), 3652.5, 3491.8, 271.170, FourCC("nrvs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrm"), 3259.1, 3795.7, 146.621, FourCC("nmrm"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrm"), 3452.7, 3421.5, 267.052, FourCC("nmrm"))
    SetUnitAcquireRange(u, 200.0)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrvs"), 3798.8, -4459.4, 88.830, FourCC("nrvs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrm"), 3405.4, -4763.3, 213.379, FourCC("nmrm"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrm"), 3599.0, -4389.1, 92.948, FourCC("nmrm"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrvs"), 3604.8, -4954.0, 88.830, FourCC("nrvs"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nplg"), -4814.8, 3562.5, 357.880, FourCC("nplg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000199_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), 1813.6, -7047.3, 331.405, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nspd"), 1557.0, -9175.2, 94.734, FourCC("nspd"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nspd"), -2958.0, 8191.6, 266.783, FourCC("nspd"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nnwl"), -2998.8, 8390.1, 275.500, FourCC("nnwl"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000224_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrvs"), -5198.6, 3507.1, 268.830, FourCC("nrvs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrm"), -4805.2, 3811.0, 33.379, FourCC("nmrm"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrm"), -4998.8, 3436.8, 272.948, FourCC("nmrm"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrvs"), -5004.6, 4001.7, 268.830, FourCC("nrvs"))
    SetUnitAcquireRange(u, 200.0)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwg"), -8915.2, 2867.1, 307.805, FourCC("nwwg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrm"), -6452.7, 1166.3, 77.976, FourCC("nmrm"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000239_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrl"), -6223.5, 1258.0, 102.726, FourCC("nmrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -6149.2, 1431.4, 120.903, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nmrm"), 4336.5, 1381.0, 108.405, FourCC("nmrm"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), 4516.3, 1486.2, 127.481, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwg"), 7548.6, -3788.6, 142.393, FourCC("nwwg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwg"), 7287.8, 2894.6, 217.607, FourCC("nwwg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000210_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nskm"), 7450.1, 2764.9, 207.779, FourCC("nskm"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nskm"), 7336.8, 3151.6, 225.147, FourCC("nskm"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwwf"), 7128.5, 3093.8, 230.529, FourCC("nwwf"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nitt"), 698.1, -4418.8, 323.280, FourCC("nitt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nitt"), -2143.3, 3581.7, 132.431, FourCC("nitt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfpu"), 67.1, -2636.9, 69.400, FourCC("nfpu"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nnwa"), 1308.8, -9292.8, 70.729, FourCC("nnwa"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nnwa"), -2462.6, -9324.4, 115.390, FourCC("nnwa"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -7063.7, -9557.7, 56.304, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwna"), -881.1, 8050.9, 303.897, FourCC("nwna"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000125_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nska"), -633.4, 8015.3, 294.058, FourCC("nska"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nska"), -1036.2, 7868.7, 314.993, FourCC("nska"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwen"), -655.2, 8221.2, 291.206, FourCC("nwen"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwen"), -1164.5, 8060.8, 313.178, FourCC("nwen"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwen"), -769.8, 7855.9, 304.821, FourCC("nwen"))
    SetUnitAcquireRange(u, 200.0)
end
...
function CreateNeutralPassiveBuildings()
    ...
    SetResourceAmount(u, 16000)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -6592.0, -6912.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 16000)
    ...
    SetResourceAmount(u, 16000)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 5184.0, 6016.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 16000)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -6720.0, 6016.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 16000)
    ...
    SetResourceAmount(u, 16000)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 5312.0, -6912.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 16000)
...
function CreateNeutralPassive()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nsea"), 4499.3, 5275.7, 193.497, FourCC("nsea"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsea"), -6011.0, 5356.9, 215.591, FourCC("nsea"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsea"), -5799.0, -6187.6, 350.046, FourCC("nsea"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsea"), 4610.5, -6217.7, 152.396, FourCC("nsea"))
...
function main()
    ...
    SetTerrainFogEx(0, 3000.0, 3500.0, 0.600, 1.000, 1.000, 1.000)
