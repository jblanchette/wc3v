...
function CreateNeutralHostile()
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrl"), -1678.8, 857.2, 348.497, FourCC("nfrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nitt"), 102.2, -4708.9, 40.620, FourCC("nitt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfsh"), 1637.0, -1015.8, 151.000, FourCC("nfsh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nplb"), -1585.1, -2310.9, 82.860, FourCC("nplb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nitp"), -103.8, -4549.9, 48.750, FourCC("nitp"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), -4103.8, -2701.8, 37.711, FourCC("nits"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nith"), -4283.2, -2485.1, 40.959, FourCC("nith"))
    SetUnitAcquireRange(u, 200.0)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nitt"), -132.1, -4371.6, 48.199, FourCC("nitt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000103_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), -1421.9, -2399.4, 76.424, FourCC("nomg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwlt"), 3009.3, 643.5, 195.061, FourCC("nwlt"))
    SetUnitAcquireRange(u, 200.0)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), -1743.5, -2318.5, 83.510, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000039_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwlt"), -2962.0, -899.1, 4.836, FourCC("nwlt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwlt"), 2957.8, 944.4, 194.226, FourCC("nwlt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpt"), -2541.0, -4040.1, 49.770, FourCC("nfpt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrb"), -1799.6, 939.6, 350.022, FourCC("nfrb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000038_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), 1752.3, -670.9, 144.475, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), -1755.2, 676.8, 324.475, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nhdc"), 554.1, 493.2, 224.740, FourCC("nhdc"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000040_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrb"), 1796.6, -933.7, 170.022, FourCC("nfrb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftb"), 1743.5, 2318.5, 263.510, FourCC("nftb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000077_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntks"), -2603.7, -3892.7, 51.260, FourCC("ntks"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntkt"), 1860.2, -2790.0, 84.351, FourCC("ntkt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmgr"), -4091.8, -2456.5, 37.607, FourCC("nmgr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmgr"), 4113.6, 2458.9, 217.260, FourCC("nmgr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000048_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsh"), -1639.9, 1021.7, 331.000, FourCC("nfsh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000005_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nplg"), 4362.1, 2283.6, 233.050, FourCC("ngz3"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000065_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nsra"), 642.3, 376.4, 222.429, FourCC("nhfp"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwlt"), -3010.7, -637.8, 2.461, FourCC("nwlt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrs"), -2977.1, -772.6, 12.790, FourCC("nfrs"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrl"), 1675.8, -851.3, 166.261, FourCC("nfrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), 1421.9, 2399.4, 256.424, FourCC("nomg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nits"), 4077.5, 2691.1, 211.590, FourCC("nits"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ntks"), 2603.7, 3892.7, 231.260, FourCC("ntks"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nitt"), -1304.4, -2352.2, 68.130, FourCC("nitt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nplb"), 1585.1, 2310.9, 262.860, FourCC("nplb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nplg"), -4296.0, -2281.3, 44.880, FourCC("ngz3"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsra"), 469.4, 609.4, 217.000, FourCC("nhfp"))
    SetUnitAcquireRange(u, 200.0)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpt"), 2541.0, 4040.1, 229.770, FourCC("nfpt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nfrs"), 2956.6, 776.5, 190.810, FourCC("nfrs"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000088_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nith"), 4296.9, 2492.3, 216.474, FourCC("nith"))
    SetUnitAcquireRange(u, 200.0)
...
function CreateNeutralPassiveBuildings()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nfr2"), 1984.0, -896.0, 270.000, FourCC("nfr2"))
    ...
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ntav"), 704.0, 960.0, 270.000, FourCC("ntav"))
...
function CreateNeutralPassive()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n000"), 3285.4, 5209.4, 204.390, FourCC("n000"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n001"), -3307.1, -5206.6, 33.540, FourCC("n001"))
    SetUnitAcquireRange(u, 200.0)
