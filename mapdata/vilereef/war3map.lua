...
function CreateNeutralHostile()
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("njga"), -5284.1, -241.9, 348.810, FourCC("njga"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nfsh"), -183.5, -4267.6, 81.700, FourCC("nfsh"))
    SetUnitAcquireRange(u, 200.0)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsgh"), -8184.6, -485.2, 6.320, FourCC("nsgh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
...
function CreateNeutralPassive()
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncrb"), -3805.2, 2961.2, 357.338, FourCC("ncrb"))
    SetUnitAcquireRange(u, 200.0)
