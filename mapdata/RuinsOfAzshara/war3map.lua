gg_rct_Moonlight_top = nil
gg_rct_Middle_moonrays = nil
gg_rct_Obelisk_top_right_moonlight = nil
gg_rct_Obelisk_top_left_moonlight = nil
gg_rct_Obelisk_bot_right_moonlight = nil
...
function CreateNeutralHostile()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), 4009.8, -3857.1, 126.316, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), 1216.4, -4574.2, 120.271, FourCC("ngrk"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "slowon")
    u = BlzCreateUnitWithSkin(p, FourCC("nqbh"), 5169.6, -2570.0, 149.945, FourCC("nqbh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), -2545.6, -323.6, 86.831, FourCC("ncen"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000044_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ncer"), -2726.7, -303.3, 90.131, FourCC("ncer"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -2360.5, -297.4, 104.970, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000009_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), 3844.1, -3986.3, 126.316, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 1290.1, -4752.2, 101.051, FourCC("nftt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nele"), 4196.1, -3852.4, 150.451, FourCC("nele"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzs"), 1247.3, 4456.1, 262.591, FourCC("nrzs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzb"), 1045.4, 4447.4, 258.593, FourCC("nrzb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000086_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ncim"), 2632.3, -1755.4, 211.498, FourCC("ncim"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "flamingarrows")
    u = BlzCreateUnitWithSkin(p, FourCC("nrzt"), 951.2, 4580.2, 265.417, FourCC("nrzt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -5245.1, -416.6, 4.790, FourCC("nftt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -4972.5, -1955.3, 19.120, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrl"), -4830.8, -2146.1, 17.526, FourCC("nmrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogm"), -282.2, -2656.9, 238.230, FourCC("nogm"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), 535.2, 2340.3, 30.727, FourCC("nomg"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nftk"), -985.9, 4499.7, 278.595, FourCC("nftk"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000108_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 2448.3, 313.6, 286.444, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000098_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -78.4, -2649.1, 215.523, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nggr"), 4002.6, -4065.4, 131.520, FourCC("nggr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000056_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftk"), 975.4, -4507.0, 98.920, FourCC("nftk"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000040_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nele"), 3743.6, -4166.6, 111.621, FourCC("nele"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), -1242.6, 4570.9, 302.945, FourCC("ngrk"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "slowon")
    u = BlzCreateUnitWithSkin(p, FourCC("nrzt"), 4791.8, -2677.0, 133.867, FourCC("nrzt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -1264.7, 4759.8, 295.315, FourCC("nftt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nqbh"), 1148.9, 4562.8, 262.710, FourCC("nqbh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncer"), 2801.8, 348.7, 271.605, FourCC("ncer"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncim"), -2257.8, 1332.0, 41.970, FourCC("ncim"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "flamingarrows")
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -436.5, -1250.2, 84.312, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncim"), -2594.1, 1763.6, 34.125, FourCC("ncim"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "flamingarrows")
    u = BlzCreateUnitWithSkin(p, FourCC("ncks"), 2453.1, -1649.1, 198.560, FourCC("ncks"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nqbh"), 4856.1, -2825.5, 131.275, FourCC("nqbh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncks"), -2404.5, 1695.5, 21.190, FourCC("ncks"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "autodispelon")
    IssueImmediateOrder(u, "bloodluston")
    t = CreateTrigger()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), -2279.8, 1542.6, 44.570, FourCC("ncen"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000077_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), 2619.9, 366.8, 268.305, FourCC("ncen"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000064_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nqbh"), -1085.0, -4499.0, 89.847, FourCC("nqbh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzt"), -861.6, -4434.3, 92.554, FourCC("nrzt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzm"), -4971.9, 2621.2, 323.890, FourCC("nrzm"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000087_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzt"), -5045.0, 2463.8, 332.366, FourCC("nrzt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nqbh"), -4882.7, 2818.2, 312.759, FourCC("nqbh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), 779.6, -4830.7, 115.716, FourCC("nftr"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), 765.8, -4648.4, 93.036, FourCC("ngrk"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "slowon")
    u = BlzCreateUnitWithSkin(p, FourCC("ncim"), 2286.3, -1313.6, 243.877, FourCC("ncim"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "flamingarrows")
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), 2312.6, -1488.2, 221.940, FourCC("ncen"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000051_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzt"), 5027.6, -2475.4, 150.882, FourCC("nrzt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzm"), 4950.5, -2630.9, 142.406, FourCC("nrzm"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000050_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzb"), -994.2, -4348.9, 85.730, FourCC("nrzb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000055_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzs"), -1207.3, -4383.3, 89.728, FourCC("nrzs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), -53.8, -1244.9, 95.467, FourCC("nfsp"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "autodispelon")
    IssueImmediateOrder(u, "healon")
    u = BlzCreateUnitWithSkin(p, FourCC("nele"), -4135.1, 3791.1, 323.378, FourCC("nele"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogm"), 277.6, 2667.8, 52.570, FourCC("nogm"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogr"), -260.2, -1256.7, 87.774, FourCC("nogr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000059_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nggr"), -3979.4, 4043.0, 304.445, FourCC("nggr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000069_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -3795.9, 3947.7, 299.243, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nele"), -3701.2, 4076.2, 284.550, FourCC("nele"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), 47.6, 1402.8, 274.508, FourCC("nfsp"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "autodispelon")
    IssueImmediateOrder(u, "healon")
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), -843.0, 4843.9, 291.542, FourCC("nftr"))
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 5194.6, 405.3, 191.860, FourCC("nftt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 430.3, 1401.7, 263.353, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nogr"), 251.1, 1405.0, 266.812, FourCC("nogr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000068_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), 5228.4, -127.8, 191.902, FourCC("nfsp"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngrk"), -790.9, 4676.7, 300.225, FourCC("ngrk"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "slowon")
    u = BlzCreateUnitWithSkin(p, FourCC("nmfs"), 4923.2, 2094.3, 233.966, FourCC("nmfs"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000106_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrzt"), -4814.5, 2671.4, 315.351, FourCC("nrzt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), -5265.0, 200.9, 319.080, FourCC("nfsp"))
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), 4883.1, 1923.6, 190.826, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrl"), 4770.4, 2132.9, 189.232, FourCC("nmrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), 5041.2, 248.5, 168.003, FourCC("ncen"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -3964.8, 3827.5, 299.243, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncks"), 5050.9, -15.5, 180.433, FourCC("ncks"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000067_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nqbh"), -5189.4, 2554.7, 331.429, FourCC("nqbh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncks"), -5050.6, -16.6, 353.360, FourCC("ncks"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000048_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nomg"), -471.5, -2313.1, 195.270, FourCC("nomg"))
    SetUnitAcquireRange(u, 200.0)
    IssueImmediateOrder(u, "bloodluston")
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -451.3, -2503.2, 229.027, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ncen"), -5053.8, -287.2, 340.930, FourCC("ncen"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 461.1, 2540.4, 47.213, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 105.2, 2614.8, 68.502, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmfs"), -4987.6, -2130.0, 62.260, FourCC("nmfs"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
...
function CreateNeutralPassiveBuildings()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -5248.0, -128.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 10000)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 1024.0, -4736.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -3712.0, -3968.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ntav"), 0.0, 0.0, 270.000, FourCC("ntav"))
    SetUnitColor(u, ConvertPlayerColor(0))
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), 2560.0, -1408.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), -2560.0, 1408.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("nmer"), 256.0, 2432.0, 270.000, FourCC("nmer"))
    SetUnitColor(u, ConvertPlayerColor(0))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -1024.0, 4736.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 3712.0, 3968.0, 270.000, FourCC("ngol"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 5248.0, 128.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 10000)
    u = BlzCreateUnitWithSkin(p, FourCC("ngad"), 5120.0, -2816.0, 270.000, FourCC("ngad"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngad"), -5120.0, 2816.0, 270.000, FourCC("ngad"))
    u = BlzCreateUnitWithSkin(p, FourCC("nmer"), -256.0, -2432.0, 270.000, FourCC("nmer"))
    SetUnitColor(u, ConvertPlayerColor(0))
end
...
function CreateNeutralPassive()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 1250.8, -3324.6, 233.927, FourCC("nder"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), -3815.4, -822.3, 272.561, FourCC("nder"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 3881.1, 1020.6, 105.283, FourCC("nder"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), -1571.8, -1609.2, 314.625, FourCC("nfro"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), 1819.4, 1523.5, 309.434, FourCC("nfro"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nshe"), -1080.3, -3422.9, 299.936, FourCC("nshe"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nshe"), 1326.2, 3313.1, 126.528, FourCC("nshe"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nshe"), -4080.5, 1519.6, 222.120, FourCC("nshe"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nshe"), 4120.9, -1505.1, 33.282, FourCC("nshe"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), -900.3, -103.9, 353.276, FourCC("nfro"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), 800.6, 32.1, 253.462, FourCC("nfro"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), -1191.9, 3413.4, 57.367, FourCC("nder"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), -1782.1, 2340.5, 314.625, FourCC("nfro"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), 1650.4, -2105.6, 314.625, FourCC("nfro"))
    SetUnitAcquireRange(u, 200.0)
end
...
function CreateRegions()
    local we
    gg_rct_Moonlight_top = Rect(-4256.0, 3744.0, -3648.0, 4352.0)
    we = AddWeatherEffect(gg_rct_Moonlight_top, FourCC("LRma"))
    EnableWeatherEffect(we, true)
    gg_rct_Middle_moonrays = Rect(-1280.0, -672.0, 1280.0, 608.0)
    we = AddWeatherEffect(gg_rct_Middle_moonrays, FourCC("LRma"))
    EnableWeatherEffect(we, true)
    gg_rct_Obelisk_top_right_moonlight = Rect(3584.0, -4224.0, 4160.0, -3648.0)
    we = AddWeatherEffect(gg_rct_Obelisk_top_right_moonlight, FourCC("LRma"))
    EnableWeatherEffect(we, true)
    gg_rct_Obelisk_top_left_moonlight = Rect(-3360.0, 2784.0, -2784.0, 3360.0)
    we = AddWeatherEffect(gg_rct_Obelisk_top_left_moonlight, FourCC("LRma"))
    EnableWeatherEffect(we, true)
    gg_rct_Obelisk_bot_right_moonlight = Rect(2784.0, -3328.0, 3360.0, -2752.0)
    we = AddWeatherEffect(gg_rct_Obelisk_bot_right_moonlight, FourCC("LRma"))
    EnableWeatherEffect(we, true)
end
...
function main()
    SetCameraBounds(-6016.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), -5632.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 6016.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 5632.0 - GetCameraMargin(CAMERA_MARGIN_TOP), -6016.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 5632.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 6016.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), -5632.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
...
function config()
    ...
    DefineStartLocation(0, -3264.0, -3328.0)
    DefineStartLocation(1, 3264.0, 3328.0)
