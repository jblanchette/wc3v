...
gg_rct_HeavySnow1 = nil
gg_rct_HeavySnow2 = nil
...
function CreateRegions()
    ...
    we = AddWeatherEffect(gg_rct_Rain3, FourCC("RLhr"))
    EnableWeatherEffect(we, true)
    ...
    EnableWeatherEffect(we, true)
    gg_rct_Moonlight1 = Rect(1920.0, -96.0, 2144.0, 128.0)
    we = AddWeatherEffect(gg_rct_Moonlight1, FourCC("LRma"))
    EnableWeatherEffect(we, true)
    gg_rct_HeavySnow1 = Rect(-3744.0, 2016.0, -1856.0, 4480.0)
    we = AddWeatherEffect(gg_rct_HeavySnow1, FourCC("SNhs"))
    EnableWeatherEffect(we, true)
    gg_rct_HeavySnow2 = Rect(5920.0, -4000.0, 7808.0, -1536.0)
    we = AddWeatherEffect(gg_rct_HeavySnow2, FourCC("SNhs"))
    EnableWeatherEffect(we, true)
end
...
function main()
    ...
    SetTerrainFogEx(0, 1500.0, 5000.0, 0.500, 1.000, 1.000, 1.000)
