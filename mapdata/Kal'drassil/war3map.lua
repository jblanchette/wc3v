DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), -4522.4, 4677.2, 316.768, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nbda"), 4887.8, 5137.7, 205.350, FourCC("nbda"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrg"), -4727.5, -4836.4, 28.030, FourCC("nfrg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000012_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), -2010.6, 6138.9, 267.270, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntks"), 5233.8, 4877.9, 279.400, FourCC("ntks"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), 2400.1, -5511.9, 106.273, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000021_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 2580.2, -5573.6, 104.269, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftt"), 2283.4, -5626.7, 107.789, FourCC("nftt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntkc"), 4900.6, 4956.3, 222.760, FourCC("ntkc"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000051_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrs"), -4743.7, -5031.7, 21.230, FourCC("nfrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrl"), -4867.8, -4685.3, 57.470, FourCC("nfrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrs"), -5061.9, -4684.3, 79.850, FourCC("nfrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwlt"), 1514.4, 1759.8, 229.673, FourCC("nwlt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrl"), 3881.6, 3970.4, 232.590, FourCC("nfrl"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000055_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nbdw"), 1733.7, -484.7, 262.470, FourCC("nbdw"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000033_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), -2191.7, 6079.7, 282.961, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000128_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nggr"), 6495.2, -372.2, 176.520, FourCC("nggr"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000120_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpt"), -608.0, 6615.0, 285.818, FourCC("nfpt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfpt"), -92.8, 6648.1, 258.492, FourCC("nfpt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nggr"), -344.5, 6486.2, 273.480, FourCC("nggr"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000118_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpt"), 422.1, -6284.7, 97.766, FourCC("nfpt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nggr"), 681.6, -6148.1, 87.481, FourCC("nggr"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000125_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpt"), 928.4, -6232.9, 101.371, FourCC("nfpt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfpt"), -6259.1, 470.3, 6.382, FourCC("nfpt"))
    u = BlzCreateUnitWithSkin(p, FourCC("nggr"), -6137.6, 687.8, 359.136, FourCC("nggr"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000081_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpt"), -6261.0, 946.8, 350.701, FourCC("nfpt"))
end
...
function CreateNeutralPassiveBuildings()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("ntav"), 448.0, 512.0, 270.000, FourCC("ntav"))
    SetUnitColor(u, ConvertPlayerColor(0))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 704.0, -6464.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), 1792.0, 1792.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 6912.0, -384.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -4992.0, -4928.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 10000)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -6464.0, 704.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 5120.0, 5120.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 10000)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -384.0, 6912.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngad"), 4928.0, -4416.0, 270.000, FourCC("ngad"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -2880.0, 1856.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 13500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), -1600.0, -1600.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("nmr8"), 2560.0, 2560.0, 270.000, FourCC("nmr8"))
    SetUnitColor(u, ConvertPlayerColor(9))
    u = BlzCreateUnitWithSkin(p, FourCC("nmrk"), -2368.0, -2368.0, 270.000, FourCC("nmrk"))
    SetUnitColor(u, ConvertPlayerColor(0))
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 1920.0, -2944.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 13500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngt2"), -5792.0, 2720.0, 270.000, FourCC("ngt2"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngad"), -4416.0, 4928.0, 270.000, FourCC("ngad"))
    u = BlzCreateUnitWithSkin(p, FourCC("eshy"), 4896.0, -5856.0, 270.000, FourCC("eshy"))
    u = BlzCreateUnitWithSkin(p, FourCC("nbwd"), 6784.0, 2176.0, 270.000, FourCC("nbwd"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfr2"), -3712.0, -4224.0, 270.000, FourCC("nfr2"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfr1"), -5504.0, -3968.0, 270.000, FourCC("nfr1"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfh0"), 3840.0, -1344.0, 270.000, FourCC("nfh0"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfh1"), -2720.0, 992.0, 270.000, FourCC("nfh1"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfr2"), 3392.0, 4224.0, 270.000, FourCC("nfr2"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngnh"), 6304.0, -2016.0, 270.000, FourCC("ngnh"))
end
...
function CreateNeutralPassive()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("ncrb"), 6527.3, -6536.0, 311.483, FourCC("ncrb"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncrb"), 6976.8, -6500.9, 186.784, FourCC("ncrb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), 6638.1, -6461.8, 72.655, FourCC("nfro"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfro"), 6331.0, -6248.5, 339.389, FourCC("nfro"))
    u = BlzCreateUnitWithSkin(p, FourCC("nhmc"), 6953.3, -6564.2, 138.014, FourCC("nhmc"))
    u = BlzCreateUnitWithSkin(p, FourCC("nhmc"), 6877.1, -6477.0, 318.822, FourCC("nhmc"))
    u = BlzCreateUnitWithSkin(p, FourCC("nhmc"), 6418.6, -6448.2, 21.204, FourCC("nhmc"))
    u = BlzCreateUnitWithSkin(p, FourCC("npng"), -4989.4, 5952.9, 299.485, FourCC("npng"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("npng"), -5154.7, 5819.4, 310.513, FourCC("npng"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("npng"), -5315.1, 5677.3, 301.265, FourCC("npng"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 2468.7, 7253.9, 238.916, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 2748.9, 7280.5, 26.555, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 2963.6, 7031.0, 42.441, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 2761.8, 6847.8, 119.139, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 2516.9, 6898.1, 262.735, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 2430.4, 7079.0, 76.522, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 2651.8, 7099.6, 78.752, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 2890.7, 6866.3, 168.975, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsno"), -1013.1, -4103.1, 115.415, FourCC("nsno"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 1972.7, -4232.8, 124.435, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 4813.1, -1410.8, 199.166, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), -1650.2, -4335.2, 105.791, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsno"), -4055.8, -1035.6, 323.239, FourCC("nsno"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 4383.4, 2050.8, 330.160, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 1396.1, -1622.4, 182.554, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), -4205.7, 1780.3, 325.565, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), -1570.1, 4882.6, 250.834, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), -4434.7, -1470.7, 344.209, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 1951.3, 4562.9, 119.840, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), -1721.9, 1575.7, 267.446, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsno"), 1000.7, 3845.8, 13.514, FourCC("nsno"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsno"), 4450.5, 3436.3, 267.240, FourCC("nsno"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 749.7, 779.3, 182.554, FourCC("nder"))
end
...
function CreateRegions()
    local we
    gg_rct_Region_000 = Rect(4128.0, 5632.0, 8160.0, 7616.0)
    we = AddWeatherEffect(gg_rct_Region_000, FourCC("MEds"))
    EnableWeatherEffect(we, true)
    gg_rct_Region_001 = Rect(5632.0, 4192.0, 8160.0, 5536.0)
    we = AddWeatherEffect(gg_rct_Region_001, FourCC("MEds"))
    EnableWeatherEffect(we, true)
    gg_rct_Region_002_Copy = Rect(320.0, 352.0, 576.0, 608.0)
    we = AddWeatherEffect(gg_rct_Region_002_Copy, FourCC("LRaa"))
    EnableWeatherEffect(we, true)
    gg_rct_Region_002_Copy_Copy = Rect(3968.0, 608.0, 4224.0, 864.0)
    we = AddWeatherEffect(gg_rct_Region_002_Copy_Copy, FourCC("LRma"))
    EnableWeatherEffect(we, true)
    gg_rct_Region_002_Copy_Copy_Copy = Rect(608.0, 3936.0, 864.0, 4192.0)
    we = AddWeatherEffect(gg_rct_Region_002_Copy_Copy_Copy, FourCC("LRma"))
    EnableWeatherEffect(we, true)
end
...
function main()
    SetCameraBounds(-6912.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), -6912.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 7424.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 7424.0 - GetCameraMargin(CAMERA_MARGIN_TOP), -6912.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 7424.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 7424.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), -6912.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
...
function config()
    ...
    DefineStartLocation(0, 6144.0, -256.0)
    DefineStartLocation(1, 576.0, -5696.0)
    DefineStartLocation(2, -256.0, 6144.0)
    DefineStartLocation(3, -5696.0, 576.0)
