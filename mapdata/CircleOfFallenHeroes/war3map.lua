...
function InitRandomGroups()
    local curset
    RandomDistReset()
    RandomDistAddItem(0, 20)
    RandomDistAddItem(1, 20)
    RandomDistAddItem(2, 20)
    RandomDistAddItem(3, 20)
    RandomDistAddItem(4, 20)
    curset = RandomDistChoose()
    if (curset == 0) then
        gg_rg_000[0] = FourCC("ngme")
        gg_rg_000[1] = FourCC("ndrg")
        gg_rg_000[2] = FourCC("ngme")
        gg_rg_000[3] = FourCC("nmrk")
        gg_rg_000[4] = FourCC("nmrc")
        gg_rg_000[5] = FourCC("nmrv")
        gg_rg_000[6] = FourCC("ngdk")
        gg_rg_000[7] = FourCC("njga")
        gg_rg_000[8] = FourCC("nsrn")
        gg_rg_000[9] = FourCC("nthl")
    elseif (curset == 1) then
        gg_rg_000[0] = FourCC("ndrg")
        gg_rg_000[1] = FourCC("ngme")
        gg_rg_000[2] = FourCC("nmrk")
        gg_rg_000[3] = FourCC("nmrc")
        gg_rg_000[4] = FourCC("ngme")
        gg_rg_000[5] = FourCC("ngdk")
        gg_rg_000[6] = FourCC("njga")
        gg_rg_000[7] = FourCC("nsrn")
        gg_rg_000[8] = FourCC("nthl")
        gg_rg_000[9] = FourCC("nmrv")
    elseif (curset == 2) then
        gg_rg_000[0] = FourCC("ngme")
        gg_rg_000[1] = FourCC("nmrk")
        gg_rg_000[2] = FourCC("nmrc")
        gg_rg_000[3] = FourCC("ngme")
        gg_rg_000[4] = FourCC("ndrg")
        gg_rg_000[5] = FourCC("njga")
        gg_rg_000[6] = FourCC("nsrn")
        gg_rg_000[7] = FourCC("nthl")
        gg_rg_000[8] = FourCC("nmrv")
        gg_rg_000[9] = FourCC("ngdk")
    elseif (curset == 3) then
        gg_rg_000[0] = FourCC("nmrk")
        gg_rg_000[1] = FourCC("nmrc")
        gg_rg_000[2] = FourCC("ngme")
        gg_rg_000[3] = FourCC("ndrg")
        gg_rg_000[4] = FourCC("ngme")
        gg_rg_000[5] = FourCC("nsrn")
        gg_rg_000[6] = FourCC("nthl")
        gg_rg_000[7] = FourCC("nmrv")
        gg_rg_000[8] = FourCC("ngdk")
        gg_rg_000[9] = FourCC("njga")
    elseif (curset == 4) then
        gg_rg_000[0] = FourCC("nmrc")
        gg_rg_000[1] = FourCC("ngme")
        gg_rg_000[2] = FourCC("ndrg")
        gg_rg_000[3] = FourCC("ngme")
        gg_rg_000[4] = FourCC("nmrk")
        gg_rg_000[5] = FourCC("nthl")
        gg_rg_000[6] = FourCC("nmrv")
        gg_rg_000[7] = FourCC("ngdk")
        gg_rg_000[8] = FourCC("njga")
        gg_rg_000[9] = FourCC("nsrn")
    else
        gg_rg_000[0] = -1
        gg_rg_000[1] = -1
        gg_rg_000[2] = -1
...
function CreateNeutralHostile()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nsgb"), 5504.0, 434.1, 3.685, FourCC("nsgb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000073_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nehy"), 5481.3, 760.8, 15.748, FourCC("nehy"))
    unitID = gg_rg_000[5]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, 1790.0, 1458.0, 31.315, unitID)
    ...
    unitID = gg_rg_000[6]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, 1961.6, -1202.3, 328.480, unitID)
        SetUnitAcquireRange(u, 200.0)
        t = CreateTrigger()
        TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
        TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    unitID = gg_rg_000[7]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, -536.8, -2237.5, 240.841, unitID)
        SetUnitAcquireRange(u, 200.0)
        t = CreateTrigger()
        TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
        TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    unitID = gg_rg_000[9]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, -783.3, 2149.0, 101.321, unitID)
        SetUnitAcquireRange(u, 200.0)
        t = CreateTrigger()
        TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
        TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    unitID = gg_rg_000[8]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, -2273.3, -95.5, 170.375, unitID)
        SetUnitAcquireRange(u, 200.0)
        t = CreateTrigger()
        TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
        TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nsra"), 1813.5, -1403.6, 317.876, FourCC("nsra"))
    SetUnitState(u, UNIT_STATE_MANA, 200)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsko"), 2044.0, -1428.0, 316.487, FourCC("nsko"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), 2135.9, -1015.0, 313.855, FourCC("nsrh"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsce"), 2223.0, -1235.8, 324.317, FourCC("nsce"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), 1638.7, 1679.7, 38.864, FourCC("nsrh"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsra"), 1906.0, 1231.9, 18.746, FourCC("nsra"))
    SetUnitState(u, UNIT_STATE_MANA, 200)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsko"), 2023.7, 1449.3, 17.533, FourCC("nsko"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsce"), 1882.2, 1673.9, 28.356, FourCC("nsce"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), -313.3, -2333.1, 245.406, FourCC("nsrh"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsra"), -755.7, -2120.6, 223.915, FourCC("nsra"))
    SetUnitState(u, UNIT_STATE_MANA, 200)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsko"), -742.7, -2330.2, 227.329, FourCC("nsko"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsce"), -516.3, -2466.1, 246.874, FourCC("nsce"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), -2323.6, -342.2, 183.981, FourCC("nsrh"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsra"), -2272.0, 174.1, 160.628, FourCC("nsra"))
    SetUnitState(u, UNIT_STATE_MANA, 200)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsko"), -2474.5, 52.7, 164.329, FourCC("nsko"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsce"), -2492.3, -214.7, 177.582, FourCC("nsce"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), -1007.6, 2127.3, 114.583, FourCC("nsrh"))
    SetUnitState(u, UNIT_STATE_MANA, 300)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsra"), -538.1, 2182.9, 89.583, FourCC("nsra"))
    SetUnitState(u, UNIT_STATE_MANA, 200)
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsko"), -673.6, 2395.7, 92.836, FourCC("nsko"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsce"), -969.2, 2363.3, 104.049, FourCC("nsce"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nehy"), 5559.0, 115.6, 342.035, FourCC("nehy"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -1728.6, -6209.6, 94.422, FourCC("ntrs"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -1275.1, -6280.1, 65.058, FourCC("ntrs"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), 5473.5, -3305.0, 148.691, FourCC("ntrt"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000050_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nsc2"), 5322.6, -3416.4, 147.197, FourCC("nsc2"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsc2"), 5490.8, -3137.7, 150.231, FourCC("nsc2"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 5663.1, -3167.4, 150.646, FourCC("ntrs"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 5462.0, -3532.3, 146.884, FourCC("ntrs"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsc2"), -1320.6, -6066.2, 73.071, FourCC("nsc2"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsc2"), -1617.3, -6024.6, 88.408, FourCC("nsc2"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), -1478.7, -6197.1, 77.791, FourCC("ntrt"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000058_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -6421.5, -357.7, 19.939, FourCC("ntrs"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -6388.4, -811.4, 339.979, FourCC("ntrs"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsc2"), -6186.6, -727.5, 355.497, FourCC("nsc2"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsc2"), -6200.5, -431.6, 10.491, FourCC("nsc2"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), -6355.1, -570.6, 359.883, FourCC("ntrt"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000063_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -2235.3, 5930.6, 306.223, FourCC("ntrs"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -2719.5, 5781.2, 273.343, FourCC("ntrs"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsc2"), -2551.7, 5604.8, 288.811, FourCC("nsc2"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsc2"), -2262.9, 5686.6, 298.756, FourCC("nsc2"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), -2451.2, 5852.7, 290.517, FourCC("ntrt"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000068_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 4934.0, 3972.7, 246.831, FourCC("ntrs"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 4646.4, 4367.6, 204.594, FourCC("ntrs"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsc2"), 4540.4, 4164.9, 207.379, FourCC("nsc2"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsc2"), 4697.5, 3958.6, 229.159, FourCC("nsc2"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), 4781.7, 4160.6, 222.370, FourCC("ntrt"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000051_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nehy"), 1788.2, -5213.3, 278.085, FourCC("nehy"))
    u = BlzCreateUnitWithSkin(p, FourCC("nehy"), 2433.1, -5041.9, 305.208, FourCC("nehy"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsgb"), 2095.8, -5123.4, 290.390, FourCC("nsgb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000076_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nehy"), -4366.6, -3351.1, 204.646, FourCC("nehy"))
    u = BlzCreateUnitWithSkin(p, FourCC("nehy"), -3909.1, -3868.5, 222.957, FourCC("nehy"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsgb"), -4194.4, -3592.2, 217.781, FourCC("nsgb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000079_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nehy"), -4602.1, 3152.5, 130.505, FourCC("nehy"))
    u = BlzCreateUnitWithSkin(p, FourCC("nehy"), -4920.2, 2536.7, 157.401, FourCC("nehy"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsgb"), -4763.7, 2870.1, 156.248, FourCC("nsgb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000082_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nehy"), 1663.2, 5321.5, 65.610, FourCC("nehy"))
    u = BlzCreateUnitWithSkin(p, FourCC("nehy"), 972.8, 5464.4, 90.267, FourCC("nehy"))
    u = BlzCreateUnitWithSkin(p, FourCC("nsgb"), 1312.6, 5400.5, 74.365, FourCC("nsgb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000085_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrel"), -1020.9, -4265.6, 69.528, FourCC("nrel"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrel"), -1357.4, -4177.2, 83.932, FourCC("nrel"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nlkl"), -1218.4, -4351.2, 74.558, FourCC("nlkl"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000097_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrel"), -4362.3, -478.8, 353.688, FourCC("nrel"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrel"), -4361.1, -110.7, 5.671, FourCC("nrel"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nlkl"), -4479.5, -277.5, 356.554, FourCC("nlkl"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000100_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrel"), -1888.3, 4017.5, 286.785, FourCC("nrel"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrel"), -1457.1, 4138.3, 290.699, FourCC("nrel"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nlkl"), -1691.2, 4162.8, 289.524, FourCC("nlkl"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000103_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrel"), 3218.7, 2901.4, 229.995, FourCC("nrel"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrel"), 3542.9, 2594.5, 231.344, FourCC("nrel"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nlkl"), 3439.1, 2806.9, 224.983, FourCC("nlkl"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000106_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -3767.8, -7289.4, 114.893, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -3390.3, -7264.8, 88.069, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000108_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), -3571.9, -7358.5, 94.618, FourCC("nsrh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000109_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrel"), 3536.2, -2562.1, 141.856, FourCC("nrel"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nlkl"), 3758.5, -2499.2, 141.635, FourCC("nlkl"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000091_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrel"), 3793.7, -2297.2, 131.935, FourCC("nrel"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmbg"), -7515.2, -1985.8, 353.480, FourCC("nmbg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000122_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmtw"), -7449.2, -2182.5, 343.220, FourCC("nmtw"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -7362.1, -1836.3, 6.130, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000132_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmbg"), -410.8, -7792.9, 65.170, FourCC("nmbg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000110_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmtw"), -213.6, -7774.0, 45.219, FourCC("nmtw"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -524.8, -7602.8, 78.134, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000112_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), -8096.3, 1133.2, 22.620, FourCC("nsrh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000113_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -8072.3, 1362.3, 42.890, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -8003.5, 971.9, 12.070, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000115_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), -1423.6, 8051.2, 310.620, FourCC("nsrh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000116_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -1234.6, 8095.1, 296.890, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), -1582.3, 7935.4, 300.070, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000118_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 7035.2, 3953.1, 207.607, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000119_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 7286.4, 3663.0, 224.953, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), 7222.9, 3835.7, 215.183, FourCC("nsrh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000093_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 5950.9, -5501.2, 125.223, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000094_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrs"), 5717.1, -5769.1, 158.080, FourCC("ntrs"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsrh"), 5883.9, -5680.9, 138.853, FourCC("nsrh"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000088_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmbg"), -4200.3, 6539.1, 281.480, FourCC("nmbg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000125_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmtw"), -4348.9, 6366.9, 271.220, FourCC("nmtw"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), -3967.7, 6438.4, 294.130, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000127_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmbg"), 4919.4, 6017.0, 209.480, FourCC("nmbg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000128_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmtw"), 4744.7, 6140.9, 199.220, FourCC("nmtw"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), 4917.7, 5818.7, 222.130, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000130_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmbg"), 7242.1, -2820.8, 137.480, FourCC("nmbg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000092_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nmtw"), 7358.6, -2677.4, 137.220, FourCC("nmtw"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nmrr"), 7011.2, -2809.0, 150.130, FourCC("nmrr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
...
function CreateNeutralPassiveBuildings()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 5696.0, -3456.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -6592.0, -576.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 4992.0, 4288.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ntav"), 0.0, 0.0, 270.000, FourCC("ntav"))
    SetUnitColor(u, ConvertPlayerColor(0))
    unitID = gg_rg_000[0]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, 1536.0, 1280.0, 270.000, unitID)
    end
    unitID = gg_rg_000[1]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, 1728.0, -1024.0, 270.000, unitID)
    end
    unitID = gg_rg_000[2]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, -448.0, -1984.0, 270.000, unitID)
    end
    unitID = gg_rg_000[3]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, -1984.0, -128.0, 270.000, unitID)
    end
    unitID = gg_rg_000[4]
    if (unitID ~= -1) then
        u = BlzCreateUnitWithSkin(p, unitID, -768.0, 1856.0, 270.000, unitID)
    end
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 1984.0, -4736.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 5120.0, 384.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 1216.0, 4992.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -4416.0, 2688.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -3904.0, -3328.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -1536.0, -6464.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), -2496.0, 6080.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
end
...
function CreateNeutralPassive()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("nhmc"), 6073.1, 3809.2, 351.211, FourCC("nhmc"))
    u = BlzCreateUnitWithSkin(p, FourCC("nalb"), 8956.3, -3005.6, 201.803, FourCC("nalb"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncrb"), -7.7, -185.5, 311.065, FourCC("ncrb"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncrb"), -6700.8, -2659.6, 32.532, FourCC("ncrb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nskk"), -4100.8, 5498.7, 137.971, FourCC("nskk"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncrb"), 3623.9, 5786.4, 123.424, FourCC("ncrb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nhmc"), 6648.4, -1851.1, 200.584, FourCC("nhmc"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncrb"), 461.9, -6892.1, 104.351, FourCC("ncrb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nhmc"), 3549.0, -2938.3, 21.940, FourCC("nhmc"))
    u = BlzCreateUnitWithSkin(p, FourCC("nhmc"), -1738.6, -4475.1, 56.362, FourCC("nhmc"))
    u = BlzCreateUnitWithSkin(p, FourCC("ncrb"), -4699.8, 360.5, 299.518, FourCC("ncrb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nhmc"), -908.9, 4571.7, 238.455, FourCC("nhmc"))
    u = BlzCreateUnitWithSkin(p, FourCC("nhmc"), 4001.7, 2409.3, 312.955, FourCC("nhmc"))
    u = BlzCreateUnitWithSkin(p, FourCC("nalb"), 4872.7, -6280.8, 132.334, FourCC("nalb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nalb"), 8704.1, 5968.7, 309.362, FourCC("nalb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nalb"), -5877.8, 7892.9, 82.719, FourCC("nalb"))
    u = BlzCreateUnitWithSkin(p, FourCC("nalb"), 434.6, 1174.1, 161.559, FourCC("nalb"))
end
...
function CreateRegions()
    local we
    gg_rct_fog0 = Rect(-5792.0, -9728.0, 448.0, -8736.0)
    we = AddWeatherEffect(gg_rct_fog0, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog1 = Rect(-5568.0, -8640.0, 448.0, -8256.0)
    we = AddWeatherEffect(gg_rct_fog1, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog2 = Rect(-5056.0, -8128.0, -3648.0, -7744.0)
    we = AddWeatherEffect(gg_rct_fog2, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog3 = Rect(8256.0, -3968.0, 10176.0, -1600.0)
    we = AddWeatherEffect(gg_rct_fog3, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog4 = Rect(7840.0, -3840.0, 8160.0, -2816.0)
    we = AddWeatherEffect(gg_rct_fog4, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog5 = Rect(9280.0, -4544.0, 10208.0, -4160.0)
    we = AddWeatherEffect(gg_rct_fog5, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog6 = Rect(-2464.0, 7712.0, -1056.0, 8096.0)
    we = AddWeatherEffect(gg_rct_fog6, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog7 = Rect(-1952.0, 8224.0, -544.0, 8608.0)
    we = AddWeatherEffect(gg_rct_fog7, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog8 = Rect(-992.0, 7200.0, -32.0, 8160.0)
    we = AddWeatherEffect(gg_rct_fog8, FourCC("FDwl"))
    EnableWeatherEffect(we, true)
    gg_rct_fog9 = Rect(-2496.0, 7200.0, -1088.0, 7648.0)
    we = AddWeatherEffect(gg_rct_fog9, FourCC("FDwl"))
    EnableWeatherEffect(we, true)
    gg_rct_fog10 = Rect(-480.0, 8224.0, -32.0, 8672.0)
    we = AddWeatherEffect(gg_rct_fog10, FourCC("FDwl"))
    EnableWeatherEffect(we, true)
    gg_rct_fog11 = Rect(-1984.0, 6688.0, -544.0, 7136.0)
    we = AddWeatherEffect(gg_rct_fog11, FourCC("FDwl"))
    EnableWeatherEffect(we, true)
    gg_rct_fog12 = Rect(-5536.0, 6688.0, -3616.0, 7072.0)
    we = AddWeatherEffect(gg_rct_fog12, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog13 = Rect(-5600.0, 6208.0, -4640.0, 6592.0)
    we = AddWeatherEffect(gg_rct_fog13, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog14 = Rect(-5600.0, 5664.0, -4160.0, 6112.0)
    we = AddWeatherEffect(gg_rct_fog14, FourCC("FDwl"))
    EnableWeatherEffect(we, true)
    gg_rct_fog15 = Rect(-4576.0, 6176.0, -3616.0, 6624.0)
    we = AddWeatherEffect(gg_rct_fog15, FourCC("FDwl"))
    EnableWeatherEffect(we, true)
    gg_rct_fog16 = Rect(-10240.0, 2624.0, -9248.0, 4576.0)
    we = AddWeatherEffect(gg_rct_fog16, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog17 = Rect(-9664.0, -7616.0, -7712.0, -5664.0)
    we = AddWeatherEffect(gg_rct_fog17, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog18 = Rect(-9184.0, -5632.0, -7744.0, -5184.0)
    we = AddWeatherEffect(gg_rct_fog18, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog19 = Rect(-10176.0, -8160.0, -8224.0, -7712.0)
    we = AddWeatherEffect(gg_rct_fog19, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog20 = Rect(-10176.0, -9152.0, -8736.0, -8224.0)
    we = AddWeatherEffect(gg_rct_fog20, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_fog21 = Rect(-9152.0, -5088.0, -7712.0, -2624.0)
    we = AddWeatherEffect(gg_rct_fog21, FourCC("FDwl"))
    EnableWeatherEffect(we, true)
    gg_rct_fog22 = Rect(-9696.0, -4064.0, -9280.0, -2592.0)
    we = AddWeatherEffect(gg_rct_fog22, FourCC("FDwl"))
    EnableWeatherEffect(we, true)
    gg_rct_fog23 = Rect(7232.0, -9184.0, 8672.0, -8224.0)
    we = AddWeatherEffect(gg_rct_fog23, FourCC("FDwl"))
    EnableWeatherEffect(we, true)
end
...
function main()
    SetCameraBounds(-9728.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), -9472.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 9728.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 9984.0 - GetCameraMargin(CAMERA_MARGIN_TOP), -9728.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 9984.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 9728.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), -9472.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
...
function config()
    ...
    DefineStartLocation(0, 1408.0, 5760.0)
    DefineStartLocation(1, 5888.0, 448.0)
    DefineStartLocation(2, 2240.0, -5504.0)
    DefineStartLocation(3, -4480.0, -3840.0)
    DefineStartLocation(4, -5120.0, 3008.0)
