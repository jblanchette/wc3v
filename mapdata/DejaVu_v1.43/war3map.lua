...
function ItemTable000002_DropItems()
    local trigWidget = nil
    local trigUnit = nil
    local itemID = 0
    local canDrop = true
...
function ItemTable000003_DropItems()
    local trigWidget = nil
    local trigUnit = nil
    local itemID = 0
    local canDrop = true
...
function ItemTable000004_DropItems()
    local trigWidget = nil
    local trigUnit = nil
    local itemID = 0
    local canDrop = true
...
function ItemTable000005_DropItems()
    local trigWidget = nil
    local trigUnit = nil
    local itemID = 0
    local canDrop = true
...
function ItemTable000006_DropItems()
    local trigWidget = nil
    local trigUnit = nil
    local itemID = 0
    local canDrop = true
...
function ItemTable000007_DropItems()
    local trigWidget = nil
    local trigUnit = nil
    local itemID = 0
    local canDrop = true
...
function ItemTable000008_DropItems()
    local trigWidget = nil
    local trigUnit = nil
    local itemID = 0
    local canDrop = true
...
function ItemTable000009_DropItems()
    local trigWidget = nil
    local trigUnit = nil
    local itemID = 0
    local canDrop = true
...
function CreateNeutralHostile()
    ...
    local t
    local life
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), 2823.5, 1586.2, 41.470, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpl"), -2984.2, 1271.5, 273.109, FourCC("nfpl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrh"), -6830.5, -2655.1, 7.984, FourCC("ntrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), -6203.8, 2112.9, 50.000, FourCC("nftr"))
    u = BlzCreateUnitWithSkin(p, FourCC("nlsn"), -6846.3, -2486.4, 39.754, FourCC("nlsn"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000002_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndth"), 5235.5, -4597.8, 175.170, FourCC("ndth"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nfpt"), -2824.1, 1295.1, 299.290, FourCC("nfpt"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000008_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfps"), 2712.2, -1423.8, 145.612, FourCC("nfps"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrl"), 1271.5, 2984.2, 183.109, FourCC("nfrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrb"), 1295.1, 2824.1, 209.287, FourCC("nfrb"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000005_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrh"), -2655.1, 6830.5, 277.984, FourCC("ntrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nlsn"), -2486.4, 6846.3, 309.754, FourCC("nlsn"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000002_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), 2960.5, 1521.9, 28.911, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000001_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), 2864.7, 1730.4, 64.323, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), 1586.2, -2823.5, 311.470, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), 1521.9, -2960.5, 298.911, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000001_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), 1730.4, -2864.7, 334.323, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), -2864.7, -1730.4, 244.323, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), -1586.2, 2823.5, 131.470, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), -1521.9, 2960.5, 118.911, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000001_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), -1730.4, 2864.7, 154.323, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), -2960.5, -1521.9, 208.911, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000001_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), -2823.5, -1586.2, 221.470, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrh"), 6830.5, 2655.1, 187.984, FourCC("ntrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -148.4, -4926.1, 8.629, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzg"), -297.1, -4974.5, 350.830, FourCC("nwzg"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000007_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), -340.9, -5125.7, 342.027, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nenf"), -196.6, -5085.3, 352.210, FourCC("nenf"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwld"), 5256.7, -4448.9, 144.837, FourCC("nwld"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000004_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndtb"), 5399.5, -4360.8, 124.970, FourCC("ndtb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsty"), 5225.0, -4727.6, 191.742, FourCC("nsty"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), 6187.0, -1960.4, 225.000, FourCC("nfsp"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    ...
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000009_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), 6203.8, -2112.9, 230.000, FourCC("nftr"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), 1960.4, 6187.0, 315.000, FourCC("nfsp"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    ...
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000009_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpl"), 2682.4, -1569.9, 171.472, FourCC("nfpl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfps"), -2712.2, 1423.8, 325.612, FourCC("nfps"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nlsn"), 6846.3, 2486.4, 219.754, FourCC("nlsn"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000002_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpl"), -2682.4, 1569.9, 351.472, FourCC("nfpl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsog"), 1803.4, -458.7, 165.000, FourCC("nsko"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000003_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nska"), 1778.4, -338.2, 145.000, FourCC("nska"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nska"), 1721.3, -553.9, 185.000, FourCC("nska"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndth"), -4597.8, -5235.5, 85.170, FourCC("ndth"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwld"), -4448.9, -5256.7, 54.837, FourCC("nwld"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000004_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndtb"), -4360.8, -5399.5, 34.970, FourCC("ndtb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsty"), -4727.6, -5225.0, 101.742, FourCC("nsty"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndth"), 4597.8, 5235.5, 265.170, FourCC("ndth"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwld"), 4448.9, 5256.7, 234.837, FourCC("nwld"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000004_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrs"), 1423.8, 2712.2, 235.612, FourCC("nfrs"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngdk"), 3164.5, -4642.3, 130.000, FourCC("ngdk"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000003_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ndtb"), 4360.8, 5399.5, 214.970, FourCC("ndtb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndtb"), -5399.5, 4360.8, 304.970, FourCC("ndtb"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsty"), 4727.6, 5225.0, 281.742, FourCC("nsty"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrl"), -1271.5, -2984.2, 3.109, FourCC("nfrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrb"), -1295.1, -2824.1, 29.287, FourCC("nfrb"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000005_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrl"), 1569.9, 2682.4, 261.472, FourCC("nfrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwld"), -5256.7, 4448.9, 324.837, FourCC("nwld"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000004_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nsty"), -5225.0, 4727.6, 11.742, FourCC("nsty"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrl"), -1569.9, -2682.4, 81.472, FourCC("nfrl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nfrs"), -1423.8, -2712.2, 55.612, FourCC("nfrs"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), 2112.9, 6203.8, 320.000, FourCC("nftr"))
    ...
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), -6187.0, 1960.4, 45.000, FourCC("nfsp"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    u = BlzCreateUnitWithSkin(p, FourCC("nfsp"), -1960.4, -6187.0, 135.000, FourCC("nfsp"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    ...
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000009_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nftr"), -2112.9, -6203.8, 140.000, FourCC("nftr"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 4926.1, -148.4, 98.629, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzg"), 4974.5, -297.1, 80.830, FourCC("nwzg"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000007_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), 5125.7, -340.9, 72.027, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nenf"), 5085.3, -196.6, 82.210, FourCC("nenf"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), 148.4, 4926.1, 188.629, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzg"), 297.1, 4974.5, 170.830, FourCC("nwzg"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000007_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), 340.9, 5125.7, 162.027, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nenf"), 196.6, 5085.3, 172.210, FourCC("nenf"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nenf"), -5085.3, 196.6, 262.210, FourCC("nenf"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), -5125.7, 340.9, 252.027, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nrog"), -4926.1, 148.4, 278.629, FourCC("nrog"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("njg1"), 3004.4, -4680.2, 140.000, FourCC("njg1"))
    u = BlzCreateUnitWithSkin(p, FourCC("njgb"), 3116.6, -4496.2, 120.000, FourCC("njgb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000006_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("njg1"), 3317.5, -4487.3, 100.000, FourCC("njg1"))
    u = BlzCreateUnitWithSkin(p, FourCC("nfpt"), 2824.1, -1295.1, 119.290, FourCC("nfpt"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000008_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nfpl"), 2984.2, -1271.5, 93.109, FourCC("nfpl"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngdk"), 4642.3, 3164.5, 220.000, FourCC("ngdk"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000003_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("njg1"), 4680.2, 3004.4, 230.000, FourCC("njg1"))
    u = BlzCreateUnitWithSkin(p, FourCC("njgb"), 4496.2, 3116.6, 210.000, FourCC("njgb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000006_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("njg1"), 4487.3, 3317.5, 190.000, FourCC("njg1"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngdk"), -4642.3, -3164.5, 40.000, FourCC("ngdk"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000003_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("njg1"), -4680.2, -3004.4, 50.000, FourCC("njg1"))
    u = BlzCreateUnitWithSkin(p, FourCC("njgb"), -4496.2, -3116.6, 30.000, FourCC("njgb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000006_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("njg1"), -4487.3, -3317.5, 10.000, FourCC("njg1"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), -2799.3, 6768.4, 266.008, FourCC("ntrt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), -6768.4, -2799.3, 356.008, FourCC("ntrt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), 6768.4, 2799.3, 176.008, FourCC("ntrt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nlpd"), 2583.3, -6709.6, 105.900, FourCC("nlpd"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nspr"), -553.8, -1720.9, 95.000, FourCC("nspr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsbm"), -466.6, -1803.0, 75.000, FourCC("nssp"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000009_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nspr"), -346.1, -1778.1, 55.000, FourCC("nspr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("njgb"), -3116.6, 4496.2, 300.000, FourCC("njgb"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000006_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("njg1"), -3317.5, 4487.3, 280.000, FourCC("njg1"))
    u = BlzCreateUnitWithSkin(p, FourCC("njg1"), -3004.4, 4680.2, 320.000, FourCC("njg1"))
    u = BlzCreateUnitWithSkin(p, FourCC("ngdk"), -3164.5, 4642.3, 310.000, FourCC("ngdk"))
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000003_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nlpd"), -6709.6, -2583.3, 15.900, FourCC("nlpd"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nlpd"), -2583.3, 6709.6, 285.900, FourCC("nlpd"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzg"), -4974.5, 297.1, 260.830, FourCC("nwzg"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000007_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nlsn"), 2486.4, -6846.3, 129.754, FourCC("nlsn"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000002_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrt"), 2799.3, -6768.4, 86.008, FourCC("ntrt"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ntrh"), 2655.1, -6830.5, 97.984, FourCC("ntrh"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nlpd"), 6709.6, 2583.3, 195.900, FourCC("nlpd"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nsog"), -1803.4, 458.7, 345.000, FourCC("nsko"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000003_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nska"), -1778.4, 338.2, 325.000, FourCC("nska"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nska"), -1721.3, 553.9, 5.000, FourCC("nska"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ndth"), -5235.5, 4597.8, 355.170, FourCC("ndth"))
    SetUnitState(u, UNIT_STATE_MANA, 1)
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000000_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nsbm"), 466.6, 1803.0, 255.000, FourCC("nssp"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, ItemTable000009_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nspr"), 346.1, 1778.1, 235.000, FourCC("nspr"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nspr"), 553.8, 1720.9, 275.000, FourCC("nspr"))
    SetUnitAcquireRange(u, 200.0)
end
...
function CreateNeutralPassiveBuildings()
    ...
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 4864.0, 3328.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngol"), 3328.0, -4864.0, 270.000, FourCC("ngol"))
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), -2944.0, 1536.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("ntav"), 0.0, 0.0, 270.000, FourCC("ntav"))
    SetUnitColor(u, ConvertPlayerColor(0))
    u = BlzCreateUnitWithSkin(p, FourCC("nmrk"), 1536.0, 2944.0, 270.000, FourCC("nmrk"))
    SetUnitColor(u, ConvertPlayerColor(0))
    u = BlzCreateUnitWithSkin(p, FourCC("nmr5"), -5504.0, 4608.0, 270.000, FourCC("nmr5"))
    ...
    SetResourceAmount(u, 12500)
    u = BlzCreateUnitWithSkin(p, FourCC("ngme"), 2944.0, -1536.0, 270.000, FourCC("ngme"))
    u = BlzCreateUnitWithSkin(p, FourCC("nmr5"), 4608.0, 5504.0, 270.000, FourCC("nmr5"))
    SetUnitColor(u, ConvertPlayerColor(10))
    u = BlzCreateUnitWithSkin(p, FourCC("nmr5"), 5504.0, -4608.0, 270.000, FourCC("nmr5"))
    SetUnitColor(u, ConvertPlayerColor(10))
    u = BlzCreateUnitWithSkin(p, FourCC("nmr5"), -4608.0, -5504.0, 270.000, FourCC("nmr5"))
...
function CreateNeutralPassive()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nrac"), 1025.1, -4090.2, 285.830, FourCC("nrac"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrac"), -4099.0, -1018.4, 285.830, FourCC("nrac"))
    u = BlzCreateUnitWithSkin(p, FourCC("necr"), 2559.0, 4610.4, 317.120, FourCC("necr"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrac"), -1023.1, 4097.7, 285.830, FourCC("nrac"))
    u = BlzCreateUnitWithSkin(p, FourCC("nhmc"), 2816.5, -6268.7, 278.640, FourCC("nhmc"))
    u = BlzCreateUnitWithSkin(p, FourCC("nskk"), -4096.6, 1026.9, 278.640, FourCC("nskk"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), -1025.7, -4094.1, 278.640, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nskk"), 4095.0, -1020.3, 278.640, FourCC("nskk"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 1021.0, 4098.8, 278.640, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nrac"), 4096.3, 1031.6, 285.830, FourCC("nrac"))
    u = BlzCreateUnitWithSkin(p, FourCC("necr"), 4606.2, -2556.8, 317.120, FourCC("necr"))
    u = BlzCreateUnitWithSkin(p, FourCC("necr"), -2561.4, -4606.0, 317.120, FourCC("necr"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), -1536.8, -510.4, 277.860, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nskk"), -515.9, 1534.1, 277.860, FourCC("nskk"))
    u = BlzCreateUnitWithSkin(p, FourCC("nder"), 1537.7, 513.7, 277.860, FourCC("nder"))
    u = BlzCreateUnitWithSkin(p, FourCC("nskk"), 509.3, -1532.2, 277.860, FourCC("nskk"))
    u = BlzCreateUnitWithSkin(p, FourCC("necr"), -4609.8, 2560.4, 317.120, FourCC("necr"))
...
function config()
    ...
    DefineStartLocation(0, -2944.0, 4160.0)
    DefineStartLocation(1, 2944.0, -4160.0)
    DefineStartLocation(2, 4160.0, 2944.0)
    DefineStartLocation(3, -4160.0, -2944.0)
