...
function CreateNeutralHostile()
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkog"), -2187.8, 4273.7, 225.643, FourCC("nkog"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000027_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), -2021.4, 4238.7, 214.086, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nkob"), -2203.0, 4434.0, 235.583, FourCC("nkob"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nbrg"), -2356.6, -2286.2, 146.370, FourCC("nbrg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nbrg"), 2791.9, -2414.6, 61.110, FourCC("nbrg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000117_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), 2620.1, -2181.8, 23.368, FourCC("nban"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), 2646.2, 2310.2, 311.830, FourCC("nwzr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000048_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nbrg"), 2546.9, 2117.0, 326.370, FourCC("nbrg"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000047_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), 2760.0, 2421.3, 293.390, FourCC("nban"))
    SetUnitAcquireRange(u, 200.0)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nban"), -2564.7, -2429.7, 113.390, FourCC("nban"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), -2229.7, -2255.1, 120.718, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), -2537.3, 2402.4, 253.587, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwzr"), -2388.2, -2437.0, 131.830, FourCC("nwzr"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nwiz"), 2538.9, 2266.5, 333.479, FourCC("nwiz"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("nkol"), 4653.4, 23.0, 172.906, FourCC("nkol"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
...
function config()
    ...
    DefineStartLocation(0, -4288.0, 3904.0)
    DefineStartLocation(1, -4288.0, -3904.0)
    DefineStartLocation(2, 4288.0, -3904.0)
    DefineStartLocation(3, 4288.0, 3904.0)
