...
function CreateNeutralHostile()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngnv"), -2177.4, 5082.7, 260.280, FourCC("ngnv"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000145_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngns"), -2351.7, 4981.8, 266.668, FourCC("ngns"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngns"), -1992.6, 5133.9, 274.693, FourCC("ngns"))
    SetUnitAcquireRange(u, 200.0)
    ...
    IssueImmediateOrder(u, "bloodlustoff")
    u = BlzCreateUnitWithSkin(p, FourCC("ngnw"), -4283.3, 3365.1, 77.291, FourCC("ngnw"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    TriggerAddAction(t, Unit000058_DropItems)
    u = BlzCreateUnitWithSkin(p, FourCC("ngnw"), -1233.5, 5061.0, 43.621, FourCC("ngnw"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngnw"), 5357.9, -1197.0, 103.734, FourCC("ngnw"))
    SetUnitAcquireRange(u, 200.0)
    t = CreateTrigger()
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_DEATH)
    TriggerRegisterUnitEvent(t, u, EVENT_UNIT_CHANGE_OWNER)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), -4386.7, 3471.6, 33.293, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), -4142.9, 3340.5, 70.937, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nitt"), -6090.5, -7342.0, 42.818, FourCC("nitt"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), -1172.4, 5172.3, 355.206, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), -1123.1, 4987.3, 32.850, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), 5444.6, -1195.5, 132.851, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("ngna"), 5240.6, -1253.1, 109.937, FourCC("ngna"))
    SetUnitAcquireRange(u, 200.0)
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("ngnb"), -2173.8, 4941.0, 288.886, FourCC("ngnb"))
    SetUnitAcquireRange(u, 200.0)
...
function config()
    ...
    DefineStartLocation(2, -832.0, 6784.0)
    DefineStartLocation(3, 6528.0, -5120.0)
    DefineStartLocation(4, 6656.0, -320.0)
    DefineStartLocation(5, 5632.0, 4288.0)
