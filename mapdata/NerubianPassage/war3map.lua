...
function CreateNeutralHostile()
    ...
    SetUnitAcquireRange(u, 200.0)
    u = BlzCreateUnitWithSkin(p, FourCC("nskm"), -2830.7, -6017.2, 114.813, FourCC("nskm"))
    SetUnitAcquireRange(u, 200.0)
...
function CreateNeutralPassive()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("npng"), -6106.3, -1423.4, 340.960, FourCC("npng"))
...
function CreateRegions()
    ...
    we = AddWeatherEffect(gg_rct_top_dragon, FourCC("WOcw"))
    EnableWeatherEffect(we, true)
    ...
    we = AddWeatherEffect(gg_rct_grave_bot, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_grave_top = Rect(2368.0, 4800.0, 3840.0, 5504.0)
    we = AddWeatherEffect(gg_rct_grave_top, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_grave_left = Rect(-7744.0, -2272.0, -6912.0, -800.0)
    we = AddWeatherEffect(gg_rct_grave_left, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    gg_rct_grave_right = Rect(7232.0, 480.0, 7904.0, 1920.0)
    we = AddWeatherEffect(gg_rct_grave_right, FourCC("FDwh"))
    EnableWeatherEffect(we, true)
    ...
    we = AddWeatherEffect(gg_rct_bottom_dragon, FourCC("WOcw"))
    EnableWeatherEffect(we, true)
end
