...
A replay file coontains a timestamped series of actions performed by the players in the match.  Each action represents a unique command that a player can perform in the game and includes commands auto-generated by WC3 itself.
