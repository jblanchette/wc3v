...
const linearScale = require("./linearScale");
...
const PathFinder = class {
  ...
  setupScaler (mapData) {
    ...
    // Parser-side only — see lib/linearScale.js. The viewer injects the real
    // CDN-loaded D3 v5 into its own GameScaler (client/js/app.js); this is the
    // Node/bundle path, which only ever needed scaleLinear.
    this.gameScaler.addDependency('_d3', linearScale);
