  ...
  static doAbilityNoTargetItemId (
    ...
    switch (abilityFlags) {
      ...
      case abilityFlagNames.LearnSkillOrTrain:
        let spellTemplate = mappings.heroAbilities[itemId];
        if (!spellTemplate) {
        ...
        const isUltimate = focusUnit.spellList &&
          focusUnit.spellList.indexOf(itemId) === focusUnit.spellList.length - 1;
        ...
        if (focusUnit._lastSkillLearn &&
            focusUnit._lastSkillLearn.itemId === itemId &&
        ...
        focusUnit._lastSkillLearn = { itemId, gameTime };
        ...
        } else if (focusUnit.learnedSkills[itemId].level < maxLevel) {
        ...
        let spell = focusUnit.learnedSkills[itemId];
