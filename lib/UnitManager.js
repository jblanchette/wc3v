...
const UnitManager = class {
	...
	makePlayer (id) {
		...
		let player = new Player(id, playerSlot, this.gameData, this.eventTimer, this.world);
    ...
    logManager.setDisabledState(!logEnabledForPlayer);
		...
		if (config.debugActions) {
			...
			console.logger(`Game Timer: ${this.eventTimer.timer.gameTime}`);
			console.logger("========================================================================");
		}
