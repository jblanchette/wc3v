...
const Unit = class {
  ...
  moveToBuild (world, building, onComplete) {
    if (this.state === "walking") {
      ...
      console.logger("cancel walk event for unit: ", this.uuid);
      this.eventTimer.cancelEvent(this.moveInfo.timerEvent);
  ...
  moveTo (world, targetX, targetY, onCompleteExtra = null) {
    if (this.state === "walking") {
      ...
      if (this.moveInfo.timerEvent) {
        ...
        if (this.moveInfo.onCompleteExtra) {
          console.logger("unit has onCompleteExtra, calling it.");
          this.moveInfo.onCompleteExtra(false);
        }
    ...
    console.logger("moving unit has extra on complete: ", this.moveInfo.onCompleteExtra);
    ...
    console.logger("unit move to action uuid: ", this.moveInfo.timerEvent.uuid);
  }
