...
// Every read_replay in the preview answers with this file, whatever path was
// asked for: the shape of the table is what is being looked at, not the
// games in it.
const PEEK_REPLAY = fs.readFileSync(
  path.join(ROOT, 'replays', '3380195801_Happy_Life_Last-Refuge-15.w3g')).toString('base64');
...
const PEEK_REPLAY = ${JSON.stringify(PEEK_REPLAY)};
  ...
  core: {
    invoke: async (cmd, args) => {
      switch (cmd) {
        ...
        case 'read_replay': return b64(PEEK_REPLAY);
