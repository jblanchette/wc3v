...
(function () {
  ...
  window.GameReportView = {
    ...
    render (host, summary, opts) {
      ...
      // Live handles that outlast a tab switch, because both register a
      // ResizeObserver and neither is released by dropping its node.
      let domHandle = null;
      let cp = null;
      ...
      return {
        destroy () {
          // Both hold a ResizeObserver (chart-panel keeps parked modes alive
